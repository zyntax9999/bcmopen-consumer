...
static int bcm_dsptchr_cli_set(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        dsptchr_reorder_cfg_dsptchr_reordr_cfg reorder_cfg_dsptchr_reordr_cfg = { .disp_enable=parm[1].value.unumber, .rdy=parm[2].value.unumber, .reordr_par_mod=parm[3].value.unumber, .per_q_egrs_congst_en=parm[4].value.unumber, .dsptch_sm_enh_mod=parm[5].value.unumber};
...
static int bcm_dsptchr_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    {
        dsptchr_reorder_cfg_dsptchr_reordr_cfg reorder_cfg_dsptchr_reordr_cfg = {.disp_enable=gtmv(m, 1), .rdy=gtmv(m, 1), .reordr_par_mod=gtmv(m, 1), .per_q_egrs_congst_en=gtmv(m, 1), .dsptch_sm_enh_mod=gtmv(m, 1)};
        if(!err) bdmf_session_print(session, "ag_drv_dsptchr_reorder_cfg_dsptchr_reordr_cfg_set( %u %u %u %u %u)\n", reorder_cfg_dsptchr_reordr_cfg.disp_enable, reorder_cfg_dsptchr_reordr_cfg.rdy, reorder_cfg_dsptchr_reordr_cfg.reordr_par_mod, reorder_cfg_dsptchr_reordr_cfg.per_q_egrs_congst_en, reorder_cfg_dsptchr_reordr_cfg.dsptch_sm_enh_mod);
        ...
        if(err || reorder_cfg_dsptchr_reordr_cfg.disp_enable!=gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.rdy!=gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.reordr_par_mod!=gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.per_q_egrs_congst_en!=gtmv(m, 1) || reorder_cfg_dsptchr_reordr_cfg.dsptch_sm_enh_mod!=gtmv(m, 1))
            return err ? err : BDMF_ERR_IO;
    }
    {
