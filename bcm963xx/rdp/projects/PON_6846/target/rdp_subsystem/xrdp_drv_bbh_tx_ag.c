...
bdmf_error_t ag_drv_bbh_tx_mac_type_set(uint8_t bbh_id_tx, uint8_t type)
{
    ...
    reg_common_configurations_mactype = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_MACTYPE, TYPE, reg_common_configurations_mactype, type);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_MACTYPE, reg_common_configurations_mactype);
...
bdmf_error_t ag_drv_bbh_tx_mac_type_get(uint8_t bbh_id_tx, uint8_t *type)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_MACTYPE, reg_common_configurations_mactype);

    *type = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_MACTYPE, TYPE, reg_common_configurations_mactype);
...
bdmf_error_t ag_drv_bbh_tx_cfg_src_id_set(uint8_t bbh_id_tx, const bbh_tx_cfg_src_id *cfg_src_id)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, reg_common_configurations_bbcfg_1_tx);
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_2_TX, reg_common_configurations_bbcfg_2_tx);

    reg_common_configurations_bbcfg_1_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, FPMSRC, reg_common_configurations_bbcfg_1_tx, cfg_src_id->fpmsrc);
    reg_common_configurations_bbcfg_1_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, SBPMSRC, reg_common_configurations_bbcfg_1_tx, cfg_src_id->sbpmsrc);
    reg_common_configurations_bbcfg_2_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_2_TX, STSRNRSRC, reg_common_configurations_bbcfg_2_tx, cfg_src_id->stsrnrsrc);
    reg_common_configurations_bbcfg_2_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_2_TX, MSGRNRSRC, reg_common_configurations_bbcfg_2_tx, cfg_src_id->msgrnrsrc);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, reg_common_configurations_bbcfg_1_tx);
    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_2_TX, reg_common_configurations_bbcfg_2_tx);
...
bdmf_error_t ag_drv_bbh_tx_cfg_src_id_get(uint8_t bbh_id_tx, bbh_tx_cfg_src_id *cfg_src_id)
{
    ...
    cfg_src_id->fpmsrc = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, FPMSRC, reg_common_configurations_bbcfg_1_tx);
    cfg_src_id->sbpmsrc = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, SBPMSRC, reg_common_configurations_bbcfg_1_tx);
    cfg_src_id->stsrnrsrc = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_2_TX, STSRNRSRC, reg_common_configurations_bbcfg_2_tx);
    cfg_src_id->msgrnrsrc = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_2_TX, MSGRNRSRC, reg_common_configurations_bbcfg_2_tx);
...
bdmf_error_t ag_drv_bbh_tx_rnr_src_id_set(uint8_t bbh_id_tx, uint8_t pdrnr0src, uint8_t pdrnr1src)
{
    ...
    reg_common_configurations_bbcfg_2_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_2_TX, PDRNR0SRC, reg_common_configurations_bbcfg_2_tx, pdrnr0src);
    reg_common_configurations_bbcfg_2_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_2_TX, PDRNR1SRC, reg_common_configurations_bbcfg_2_tx, pdrnr1src);
...
bdmf_error_t ag_drv_bbh_tx_rnr_src_id_get(uint8_t bbh_id_tx, uint8_t *pdrnr0src, uint8_t *pdrnr1src)
{
    ...
    *pdrnr0src = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_2_TX, PDRNR0SRC, reg_common_configurations_bbcfg_2_tx);
    *pdrnr1src = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_2_TX, PDRNR1SRC, reg_common_configurations_bbcfg_2_tx);
...
bdmf_error_t ag_drv_bbh_tx_bbh_dma_cfg_set(uint8_t bbh_id_tx, const bbh_tx_bbh_dma_cfg *bbh_dma_cfg)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, reg_common_configurations_bbcfg_1_tx);
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DMACFG_TX, reg_common_configurations_dmacfg_tx);

    reg_common_configurations_bbcfg_1_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, DMASRC, reg_common_configurations_bbcfg_1_tx, bbh_dma_cfg->dmasrc);
    reg_common_configurations_dmacfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DMACFG_TX, DESCBASE, reg_common_configurations_dmacfg_tx, bbh_dma_cfg->descbase);
    reg_common_configurations_dmacfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DMACFG_TX, DESCSIZE, reg_common_configurations_dmacfg_tx, bbh_dma_cfg->descsize);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, reg_common_configurations_bbcfg_1_tx);
    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DMACFG_TX, reg_common_configurations_dmacfg_tx);
...
bdmf_error_t ag_drv_bbh_tx_bbh_dma_cfg_get(uint8_t bbh_id_tx, bbh_tx_bbh_dma_cfg *bbh_dma_cfg)
{
    ...
    bbh_dma_cfg->dmasrc = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, DMASRC, reg_common_configurations_bbcfg_1_tx);
    bbh_dma_cfg->descbase = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DMACFG_TX, DESCBASE, reg_common_configurations_dmacfg_tx);
    bbh_dma_cfg->descsize = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DMACFG_TX, DESCSIZE, reg_common_configurations_dmacfg_tx);
...
bdmf_error_t ag_drv_bbh_tx_dma_max_otf_read_request_set(uint8_t bbh_id_tx, uint8_t maxreq)
{
    ...
    reg_common_configurations_dmacfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DMACFG_TX, MAXREQ, reg_common_configurations_dmacfg_tx, maxreq);
...
bdmf_error_t ag_drv_bbh_tx_dma_max_otf_read_request_get(uint8_t bbh_id_tx, uint8_t *maxreq)
{
    ...
    *maxreq = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DMACFG_TX, MAXREQ, reg_common_configurations_dmacfg_tx);
...
bdmf_error_t ag_drv_bbh_tx_dma_epon_urgent_set(uint8_t bbh_id_tx, bdmf_boolean epnurgnt)
{
    ...
    reg_common_configurations_dmacfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DMACFG_TX, EPNURGNT, reg_common_configurations_dmacfg_tx, epnurgnt);
...
bdmf_error_t ag_drv_bbh_tx_dma_epon_urgent_get(uint8_t bbh_id_tx, bdmf_boolean *epnurgnt)
{
    ...
    *epnurgnt = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DMACFG_TX, EPNURGNT, reg_common_configurations_dmacfg_tx);
...
bdmf_error_t ag_drv_bbh_tx_bbh_sdma_cfg_set(uint8_t bbh_id_tx, const bbh_tx_bbh_sdma_cfg *bbh_sdma_cfg)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, reg_common_configurations_bbcfg_1_tx);
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SDMACFG_TX, reg_common_configurations_sdmacfg_tx);

    reg_common_configurations_bbcfg_1_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, SDMASRC, reg_common_configurations_bbcfg_1_tx, bbh_sdma_cfg->sdmasrc);
    reg_common_configurations_sdmacfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SDMACFG_TX, DESCBASE, reg_common_configurations_sdmacfg_tx, bbh_sdma_cfg->descbase);
    reg_common_configurations_sdmacfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SDMACFG_TX, DESCSIZE, reg_common_configurations_sdmacfg_tx, bbh_sdma_cfg->descsize);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, reg_common_configurations_bbcfg_1_tx);
    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SDMACFG_TX, reg_common_configurations_sdmacfg_tx);
...
bdmf_error_t ag_drv_bbh_tx_bbh_sdma_cfg_get(uint8_t bbh_id_tx, bbh_tx_bbh_sdma_cfg *bbh_sdma_cfg)
{
    ...
    bbh_sdma_cfg->sdmasrc = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBCFG_1_TX, SDMASRC, reg_common_configurations_bbcfg_1_tx);
    bbh_sdma_cfg->descbase = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SDMACFG_TX, DESCBASE, reg_common_configurations_sdmacfg_tx);
    bbh_sdma_cfg->descsize = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SDMACFG_TX, DESCSIZE, reg_common_configurations_sdmacfg_tx);
...
bdmf_error_t ag_drv_bbh_tx_sdma_max_otf_read_request_set(uint8_t bbh_id_tx, uint8_t maxreq)
{
    ...
    reg_common_configurations_sdmacfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SDMACFG_TX, MAXREQ, reg_common_configurations_sdmacfg_tx, maxreq);
...
bdmf_error_t ag_drv_bbh_tx_sdma_max_otf_read_request_get(uint8_t bbh_id_tx, uint8_t *maxreq)
{
    ...
    *maxreq = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SDMACFG_TX, MAXREQ, reg_common_configurations_sdmacfg_tx);
...
bdmf_error_t ag_drv_bbh_tx_sdma_epon_urgent_set(uint8_t bbh_id_tx, bdmf_boolean epnurgnt)
{
    ...
    reg_common_configurations_sdmacfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SDMACFG_TX, EPNURGNT, reg_common_configurations_sdmacfg_tx, epnurgnt);
...
bdmf_error_t ag_drv_bbh_tx_sdma_epon_urgent_get(uint8_t bbh_id_tx, bdmf_boolean *epnurgnt)
{
    ...
    *epnurgnt = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SDMACFG_TX, EPNURGNT, reg_common_configurations_sdmacfg_tx);
...
bdmf_error_t ag_drv_bbh_tx_bbh_ddr_cfg_set(uint8_t bbh_id_tx, const bbh_tx_bbh_ddr_cfg *bbh_ddr_cfg)
{
    ...
    reg_common_configurations_ddrcfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, BUFSIZE, reg_common_configurations_ddrcfg_tx, bbh_ddr_cfg->bufsize);
    reg_common_configurations_ddrcfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, BYTERESUL, reg_common_configurations_ddrcfg_tx, bbh_ddr_cfg->byteresul);
    reg_common_configurations_ddrcfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, DDRTXOFFSET, reg_common_configurations_ddrcfg_tx, bbh_ddr_cfg->ddrtxoffset);
    reg_common_configurations_ddrcfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, HNSIZE0, reg_common_configurations_ddrcfg_tx, bbh_ddr_cfg->hnsize0);
    reg_common_configurations_ddrcfg_tx = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, HNSIZE1, reg_common_configurations_ddrcfg_tx, bbh_ddr_cfg->hnsize1);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, reg_common_configurations_ddrcfg_tx);
...
bdmf_error_t ag_drv_bbh_tx_bbh_ddr_cfg_get(uint8_t bbh_id_tx, bbh_tx_bbh_ddr_cfg *bbh_ddr_cfg)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, reg_common_configurations_ddrcfg_tx);

    bbh_ddr_cfg->bufsize = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, BUFSIZE, reg_common_configurations_ddrcfg_tx);
    bbh_ddr_cfg->byteresul = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, BYTERESUL, reg_common_configurations_ddrcfg_tx);
    bbh_ddr_cfg->ddrtxoffset = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, DDRTXOFFSET, reg_common_configurations_ddrcfg_tx);
    bbh_ddr_cfg->hnsize0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, HNSIZE0, reg_common_configurations_ddrcfg_tx);
    bbh_ddr_cfg->hnsize1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DDRCFG_TX, HNSIZE1, reg_common_configurations_ddrcfg_tx);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_get(uint8_t bbh_id_tx, bbh_tx_debug_counters *debug_counters)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SRAMPD, reg_debug_counters_srampd);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_DDRPD, reg_debug_counters_ddrpd);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_PDDROP, reg_debug_counters_pddrop);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_STSCNT, reg_debug_counters_stscnt);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_STSDROP, reg_debug_counters_stsdrop);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_MSGCNT, reg_debug_counters_msgcnt);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_MSGDROP, reg_debug_counters_msgdrop);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_GETNEXTNULL, reg_debug_counters_getnextnull);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_LENERR, reg_debug_counters_lenerr);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_AGGRLENERR, reg_debug_counters_aggrlenerr);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SRAMPKT, reg_debug_counters_srampkt);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_DDRPKT, reg_debug_counters_ddrpkt);
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_FLUSHPKTS, reg_debug_counters_flushpkts);

    debug_counters->srampd = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SRAMPD, SRAMPD, reg_debug_counters_srampd);
    debug_counters->ddrpd = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_DDRPD, DDRPD, reg_debug_counters_ddrpd);
    debug_counters->pddrop = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_PDDROP, PDDROP, reg_debug_counters_pddrop);
    debug_counters->stscnt = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_STSCNT, STSCNT, reg_debug_counters_stscnt);
    debug_counters->stsdrop = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_STSDROP, STSDROP, reg_debug_counters_stsdrop);
    debug_counters->msgcnt = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_MSGCNT, MSGCNT, reg_debug_counters_msgcnt);
    debug_counters->msgdrop = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_MSGDROP, MSGDROP, reg_debug_counters_msgdrop);
    debug_counters->getnextnull = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_GETNEXTNULL, GETNEXTNULL, reg_debug_counters_getnextnull);
    debug_counters->lenerr = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_LENERR, LENERR, reg_debug_counters_lenerr);
    debug_counters->aggrlenerr = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_AGGRLENERR, AGGRLENERR, reg_debug_counters_aggrlenerr);
    debug_counters->srampkt = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SRAMPKT, SRAMPKT, reg_debug_counters_srampkt);
    debug_counters->ddrpkt = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_DDRPKT, DDRPKT, reg_debug_counters_ddrpkt);
    debug_counters->flshpkts = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_FLUSHPKTS, FLSHPKTS, reg_debug_counters_flushpkts);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_rnrcfg_1_set(uint8_t bbh_id_tx, uint8_t rnr_cfg_index_1, uint16_t tcontaddr, uint16_t skbaddr)
{
    ...
    reg_common_configurations_rnrcfg_1 = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_1, TCONTADDR, reg_common_configurations_rnrcfg_1, tcontaddr);
    reg_common_configurations_rnrcfg_1 = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_1, SKBADDR, reg_common_configurations_rnrcfg_1, skbaddr);

    RU_REG_RAM_WRITE(bbh_id_tx, rnr_cfg_index_1, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_1, reg_common_configurations_rnrcfg_1);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_rnrcfg_1_get(uint8_t bbh_id_tx, uint8_t rnr_cfg_index_1, uint16_t *tcontaddr, uint16_t *skbaddr)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, rnr_cfg_index_1, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_1, reg_common_configurations_rnrcfg_1);

    *tcontaddr = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_1, TCONTADDR, reg_common_configurations_rnrcfg_1);
    *skbaddr = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_1, SKBADDR, reg_common_configurations_rnrcfg_1);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_rnrcfg_2_set(uint8_t bbh_id_tx, uint16_t rnr_cfg_index_2, uint16_t ptraddr, uint8_t task)
{
    ...
    reg_common_configurations_rnrcfg_2 = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_2, PTRADDR, reg_common_configurations_rnrcfg_2, ptraddr);
    reg_common_configurations_rnrcfg_2 = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_2, TASK, reg_common_configurations_rnrcfg_2, task);

    RU_REG_RAM_WRITE(bbh_id_tx, rnr_cfg_index_2, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_2, reg_common_configurations_rnrcfg_2);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_rnrcfg_2_get(uint8_t bbh_id_tx, uint16_t rnr_cfg_index_2, uint16_t *ptraddr, uint8_t *task)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, rnr_cfg_index_2, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_2, reg_common_configurations_rnrcfg_2);

    *ptraddr = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_2, PTRADDR, reg_common_configurations_rnrcfg_2);
    *task = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_RNRCFG_2, TASK, reg_common_configurations_rnrcfg_2);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_sbpmcfg_set(uint8_t bbh_id_tx, bdmf_boolean freenocntxt, bdmf_boolean specialfree, uint8_t maxgn)
{
    ...
    reg_common_configurations_sbpmcfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SBPMCFG, FREENOCNTXT, reg_common_configurations_sbpmcfg, freenocntxt);
    reg_common_configurations_sbpmcfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SBPMCFG, SPECIALFREE, reg_common_configurations_sbpmcfg, specialfree);
    reg_common_configurations_sbpmcfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SBPMCFG, MAXGN, reg_common_configurations_sbpmcfg, maxgn);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SBPMCFG, reg_common_configurations_sbpmcfg);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_sbpmcfg_get(uint8_t bbh_id_tx, bdmf_boolean *freenocntxt, bdmf_boolean *specialfree, uint8_t *maxgn)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SBPMCFG, reg_common_configurations_sbpmcfg);

    *freenocntxt = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SBPMCFG, FREENOCNTXT, reg_common_configurations_sbpmcfg);
    *specialfree = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SBPMCFG, SPECIALFREE, reg_common_configurations_sbpmcfg);
    *maxgn = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_SBPMCFG, MAXGN, reg_common_configurations_sbpmcfg);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_ddrtmbasel_set(uint8_t bbh_id_tx, uint8_t zero, const bbh_tx_common_configurations_ddrtmbasel *common_configurations_ddrtmbasel)
{
    ...
    RU_REG_RAM_WRITE(bbh_id_tx, zero *2 + 0, BBH_TX, COMMON_CONFIGURATIONS_DDRTMBASEL, common_configurations_ddrtmbasel->addr[0]);
    RU_REG_RAM_WRITE(bbh_id_tx, zero *2 + 1, BBH_TX, COMMON_CONFIGURATIONS_DDRTMBASEL, common_configurations_ddrtmbasel->addr[1]);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_ddrtmbasel_get(uint8_t bbh_id_tx, uint8_t zero, bbh_tx_common_configurations_ddrtmbasel *common_configurations_ddrtmbasel)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, zero *2 + 0, BBH_TX, COMMON_CONFIGURATIONS_DDRTMBASEL, common_configurations_ddrtmbasel->addr[0]);
    RU_REG_RAM_READ(bbh_id_tx, zero *2 + 1, BBH_TX, COMMON_CONFIGURATIONS_DDRTMBASEL, common_configurations_ddrtmbasel->addr[1]);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_ddrtmbaseh_set(uint8_t bbh_id_tx, uint8_t zero, const bbh_tx_common_configurations_ddrtmbaseh *common_configurations_ddrtmbaseh)
{
    ...
    RU_REG_RAM_WRITE(bbh_id_tx, zero *2 + 0, BBH_TX, COMMON_CONFIGURATIONS_DDRTMBASEH, common_configurations_ddrtmbaseh->addr[0]);
    RU_REG_RAM_WRITE(bbh_id_tx, zero *2 + 1, BBH_TX, COMMON_CONFIGURATIONS_DDRTMBASEH, common_configurations_ddrtmbaseh->addr[1]);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_ddrtmbaseh_get(uint8_t bbh_id_tx, uint8_t zero, bbh_tx_common_configurations_ddrtmbaseh *common_configurations_ddrtmbaseh)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, zero *2 + 0, BBH_TX, COMMON_CONFIGURATIONS_DDRTMBASEH, common_configurations_ddrtmbaseh->addr[0]);
    RU_REG_RAM_READ(bbh_id_tx, zero *2 + 1, BBH_TX, COMMON_CONFIGURATIONS_DDRTMBASEH, common_configurations_ddrtmbaseh->addr[1]);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_dfifoctrl_set(uint8_t bbh_id_tx, uint16_t psramsize, uint16_t ddrsize, uint16_t psrambase)
{
    ...
    reg_common_configurations_dfifoctrl = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DFIFOCTRL, PSRAMSIZE, reg_common_configurations_dfifoctrl, psramsize);
    reg_common_configurations_dfifoctrl = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DFIFOCTRL, DDRSIZE, reg_common_configurations_dfifoctrl, ddrsize);
    reg_common_configurations_dfifoctrl = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DFIFOCTRL, PSRAMBASE, reg_common_configurations_dfifoctrl, psrambase);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DFIFOCTRL, reg_common_configurations_dfifoctrl);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_dfifoctrl_get(uint8_t bbh_id_tx, uint16_t *psramsize, uint16_t *ddrsize, uint16_t *psrambase)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DFIFOCTRL, reg_common_configurations_dfifoctrl);

    *psramsize = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DFIFOCTRL, PSRAMSIZE, reg_common_configurations_dfifoctrl);
    *ddrsize = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DFIFOCTRL, DDRSIZE, reg_common_configurations_dfifoctrl);
    *psrambase = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DFIFOCTRL, PSRAMBASE, reg_common_configurations_dfifoctrl);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_arb_cfg_set(uint8_t bbh_id_tx, bdmf_boolean hightrxq)
{
    ...
    reg_common_configurations_arb_cfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_ARB_CFG, HIGHTRXQ, reg_common_configurations_arb_cfg, hightrxq);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_ARB_CFG, reg_common_configurations_arb_cfg);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_arb_cfg_get(uint8_t bbh_id_tx, bdmf_boolean *hightrxq)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_ARB_CFG, reg_common_configurations_arb_cfg);

    *hightrxq = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_ARB_CFG, HIGHTRXQ, reg_common_configurations_arb_cfg);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_bbroute_set(uint8_t bbh_id_tx, uint16_t route, uint8_t dest, bdmf_boolean en)
{
    ...
    reg_common_configurations_bbroute = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBROUTE, ROUTE, reg_common_configurations_bbroute, route);
    reg_common_configurations_bbroute = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBROUTE, DEST, reg_common_configurations_bbroute, dest);
    reg_common_configurations_bbroute = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBROUTE, EN, reg_common_configurations_bbroute, en);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBROUTE, reg_common_configurations_bbroute);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_bbroute_get(uint8_t bbh_id_tx, uint16_t *route, uint8_t *dest, bdmf_boolean *en)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBROUTE, reg_common_configurations_bbroute);

    *route = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBROUTE, ROUTE, reg_common_configurations_bbroute);
    *dest = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBROUTE, DEST, reg_common_configurations_bbroute);
    *en = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_BBROUTE, EN, reg_common_configurations_bbroute);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_q2rnr_set(uint8_t bbh_id_tx, uint8_t q_2_rnr_index, bdmf_boolean q0, bdmf_boolean q1)
{
    ...
    reg_common_configurations_q2rnr = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_Q2RNR, Q0, reg_common_configurations_q2rnr, q0);
    reg_common_configurations_q2rnr = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_Q2RNR, Q1, reg_common_configurations_q2rnr, q1);

    RU_REG_RAM_WRITE(bbh_id_tx, q_2_rnr_index, BBH_TX, COMMON_CONFIGURATIONS_Q2RNR, reg_common_configurations_q2rnr);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_q2rnr_get(uint8_t bbh_id_tx, uint8_t q_2_rnr_index, bdmf_boolean *q0, bdmf_boolean *q1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, q_2_rnr_index, BBH_TX, COMMON_CONFIGURATIONS_Q2RNR, reg_common_configurations_q2rnr);

    *q0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_Q2RNR, Q0, reg_common_configurations_q2rnr);
    *q1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_Q2RNR, Q1, reg_common_configurations_q2rnr);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_perqtask_set(uint8_t bbh_id_tx, const bbh_tx_common_configurations_perqtask *common_configurations_perqtask)
{
    ...
    reg_common_configurations_perqtask = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK0, reg_common_configurations_perqtask, common_configurations_perqtask->task0);
    reg_common_configurations_perqtask = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK1, reg_common_configurations_perqtask, common_configurations_perqtask->task1);
    reg_common_configurations_perqtask = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK2, reg_common_configurations_perqtask, common_configurations_perqtask->task2);
    reg_common_configurations_perqtask = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK3, reg_common_configurations_perqtask, common_configurations_perqtask->task3);
    reg_common_configurations_perqtask = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK4, reg_common_configurations_perqtask, common_configurations_perqtask->task4);
    reg_common_configurations_perqtask = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK5, reg_common_configurations_perqtask, common_configurations_perqtask->task5);
    reg_common_configurations_perqtask = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK6, reg_common_configurations_perqtask, common_configurations_perqtask->task6);
    reg_common_configurations_perqtask = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK7, reg_common_configurations_perqtask, common_configurations_perqtask->task7);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, reg_common_configurations_perqtask);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_perqtask_get(uint8_t bbh_id_tx, bbh_tx_common_configurations_perqtask *common_configurations_perqtask)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, reg_common_configurations_perqtask);

    common_configurations_perqtask->task0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK0, reg_common_configurations_perqtask);
    common_configurations_perqtask->task1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK1, reg_common_configurations_perqtask);
    common_configurations_perqtask->task2 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK2, reg_common_configurations_perqtask);
    common_configurations_perqtask->task3 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK3, reg_common_configurations_perqtask);
    common_configurations_perqtask->task4 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK4, reg_common_configurations_perqtask);
    common_configurations_perqtask->task5 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK5, reg_common_configurations_perqtask);
    common_configurations_perqtask->task6 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK6, reg_common_configurations_perqtask);
    common_configurations_perqtask->task7 = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_PERQTASK, TASK7, reg_common_configurations_perqtask);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_txrstcmd_set(uint8_t bbh_id_tx, const bbh_tx_common_configurations_txrstcmd *common_configurations_txrstcmd)
{
    ...
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, CNTXTRST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->cntxtrst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, PDFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->pdfiforst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, DMAPTRRST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->dmaptrrst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, SDMAPTRRST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->sdmaptrrst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, BPMFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->bpmfiforst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, SBPMFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->sbpmfiforst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, OKFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->okfiforst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, DDRFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->ddrfiforst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, SRAMFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->sramfiforst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, SKBPTRRST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->skbptrrst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, STSFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->stsfiforst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, REQFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->reqfiforst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, MSGFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->msgfiforst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, GNXTFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->gnxtfiforst);
    reg_common_configurations_txrstcmd = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, FBNFIFORST, reg_common_configurations_txrstcmd, common_configurations_txrstcmd->fbnfiforst);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, reg_common_configurations_txrstcmd);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_txrstcmd_get(uint8_t bbh_id_tx, bbh_tx_common_configurations_txrstcmd *common_configurations_txrstcmd)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, reg_common_configurations_txrstcmd);

    common_configurations_txrstcmd->cntxtrst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, CNTXTRST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->pdfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, PDFIFORST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->dmaptrrst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, DMAPTRRST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->sdmaptrrst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, SDMAPTRRST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->bpmfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, BPMFIFORST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->sbpmfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, SBPMFIFORST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->okfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, OKFIFORST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->ddrfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, DDRFIFORST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->sramfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, SRAMFIFORST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->skbptrrst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, SKBPTRRST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->stsfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, STSFIFORST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->reqfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, REQFIFORST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->msgfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, MSGFIFORST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->gnxtfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, GNXTFIFORST, reg_common_configurations_txrstcmd);
    common_configurations_txrstcmd->fbnfiforst = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_TXRSTCMD, FBNFIFORST, reg_common_configurations_txrstcmd);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_dbgsel_set(uint8_t bbh_id_tx, uint8_t dbgsel)
{
    ...
    reg_common_configurations_dbgsel = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DBGSEL, DBGSEL, reg_common_configurations_dbgsel, dbgsel);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DBGSEL, reg_common_configurations_dbgsel);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_dbgsel_get(uint8_t bbh_id_tx, uint8_t *dbgsel)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DBGSEL, reg_common_configurations_dbgsel);

    *dbgsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_DBGSEL, DBGSEL, reg_common_configurations_dbgsel);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_clk_gate_cntrl_set(uint8_t bbh_id_tx, const bbh_tx_common_configurations_clk_gate_cntrl *common_configurations_clk_gate_cntrl)
{
    ...
    reg_common_configurations_clk_gate_cntrl = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, BYPASS_CLK_GATE, reg_common_configurations_clk_gate_cntrl, common_configurations_clk_gate_cntrl->bypass_clk_gate);
    reg_common_configurations_clk_gate_cntrl = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, TIMER_VAL, reg_common_configurations_clk_gate_cntrl, common_configurations_clk_gate_cntrl->timer_val);
    reg_common_configurations_clk_gate_cntrl = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, KEEP_ALIVE_EN, reg_common_configurations_clk_gate_cntrl, common_configurations_clk_gate_cntrl->keep_alive_en);
    reg_common_configurations_clk_gate_cntrl = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, KEEP_ALIVE_INTRVL, reg_common_configurations_clk_gate_cntrl, common_configurations_clk_gate_cntrl->keep_alive_intrvl);
    reg_common_configurations_clk_gate_cntrl = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, KEEP_ALIVE_CYC, reg_common_configurations_clk_gate_cntrl, common_configurations_clk_gate_cntrl->keep_alive_cyc);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, reg_common_configurations_clk_gate_cntrl);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_clk_gate_cntrl_get(uint8_t bbh_id_tx, bbh_tx_common_configurations_clk_gate_cntrl *common_configurations_clk_gate_cntrl)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, reg_common_configurations_clk_gate_cntrl);

    common_configurations_clk_gate_cntrl->bypass_clk_gate = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, BYPASS_CLK_GATE, reg_common_configurations_clk_gate_cntrl);
    common_configurations_clk_gate_cntrl->timer_val = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, TIMER_VAL, reg_common_configurations_clk_gate_cntrl);
    common_configurations_clk_gate_cntrl->keep_alive_en = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, KEEP_ALIVE_EN, reg_common_configurations_clk_gate_cntrl);
    common_configurations_clk_gate_cntrl->keep_alive_intrvl = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, KEEP_ALIVE_INTRVL, reg_common_configurations_clk_gate_cntrl);
    common_configurations_clk_gate_cntrl->keep_alive_cyc = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_CLK_GATE_CNTRL, KEEP_ALIVE_CYC, reg_common_configurations_clk_gate_cntrl);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_gpr_set(uint8_t bbh_id_tx, uint32_t gpr)
{
    ...
    reg_common_configurations_gpr = RU_FIELD_SET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_GPR, GPR, reg_common_configurations_gpr, gpr);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_GPR, reg_common_configurations_gpr);
...
bdmf_error_t ag_drv_bbh_tx_common_configurations_gpr_get(uint8_t bbh_id_tx, uint32_t *gpr)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_GPR, reg_common_configurations_gpr);

    *gpr = RU_FIELD_GET(bbh_id_tx, BBH_TX, COMMON_CONFIGURATIONS_GPR, GPR, reg_common_configurations_gpr);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdbase_set(uint8_t bbh_id_tx, uint8_t wan_pd_base_index, uint16_t fifobase0, uint16_t fifobase1)
{
    ...
    reg_wan_configurations_pdbase = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDBASE, FIFOBASE0, reg_wan_configurations_pdbase, fifobase0);
    reg_wan_configurations_pdbase = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDBASE, FIFOBASE1, reg_wan_configurations_pdbase, fifobase1);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_pd_base_index, BBH_TX, WAN_CONFIGURATIONS_PDBASE, reg_wan_configurations_pdbase);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdbase_get(uint8_t bbh_id_tx, uint8_t wan_pd_base_index, uint16_t *fifobase0, uint16_t *fifobase1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_pd_base_index, BBH_TX, WAN_CONFIGURATIONS_PDBASE, reg_wan_configurations_pdbase);

    *fifobase0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDBASE, FIFOBASE0, reg_wan_configurations_pdbase);
    *fifobase1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDBASE, FIFOBASE1, reg_wan_configurations_pdbase);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdsize_set(uint8_t bbh_id_tx, uint8_t wan_pd_size_index, uint16_t fifosize0, uint16_t fifosize1)
{
    ...
    reg_wan_configurations_pdsize = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDSIZE, FIFOSIZE0, reg_wan_configurations_pdsize, fifosize0);
    reg_wan_configurations_pdsize = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDSIZE, FIFOSIZE1, reg_wan_configurations_pdsize, fifosize1);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_pd_size_index, BBH_TX, WAN_CONFIGURATIONS_PDSIZE, reg_wan_configurations_pdsize);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdsize_get(uint8_t bbh_id_tx, uint8_t wan_pd_size_index, uint16_t *fifosize0, uint16_t *fifosize1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_pd_size_index, BBH_TX, WAN_CONFIGURATIONS_PDSIZE, reg_wan_configurations_pdsize);

    *fifosize0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDSIZE, FIFOSIZE0, reg_wan_configurations_pdsize);
    *fifosize1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDSIZE, FIFOSIZE1, reg_wan_configurations_pdsize);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdwkuph_set(uint8_t bbh_id_tx, uint8_t wan_pd_wkup_index, uint8_t wkupthresh0, uint8_t wkupthresh1)
{
    ...
    reg_wan_configurations_pdwkuph = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDWKUPH, WKUPTHRESH0, reg_wan_configurations_pdwkuph, wkupthresh0);
    reg_wan_configurations_pdwkuph = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDWKUPH, WKUPTHRESH1, reg_wan_configurations_pdwkuph, wkupthresh1);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_pd_wkup_index, BBH_TX, WAN_CONFIGURATIONS_PDWKUPH, reg_wan_configurations_pdwkuph);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdwkuph_get(uint8_t bbh_id_tx, uint8_t wan_pd_wkup_index, uint8_t *wkupthresh0, uint8_t *wkupthresh1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_pd_wkup_index, BBH_TX, WAN_CONFIGURATIONS_PDWKUPH, reg_wan_configurations_pdwkuph);

    *wkupthresh0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDWKUPH, WKUPTHRESH0, reg_wan_configurations_pdwkuph);
    *wkupthresh1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDWKUPH, WKUPTHRESH1, reg_wan_configurations_pdwkuph);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pd_byte_th_set(uint8_t bbh_id_tx, uint8_t wan_pd_byte_th_index, uint16_t pdlimit0, uint16_t pdlimit1)
{
    ...
    reg_wan_configurations_pd_byte_th = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT0, reg_wan_configurations_pd_byte_th, pdlimit0);
    reg_wan_configurations_pd_byte_th = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT1, reg_wan_configurations_pd_byte_th, pdlimit1);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_pd_byte_th_index, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH, reg_wan_configurations_pd_byte_th);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pd_byte_th_get(uint8_t bbh_id_tx, uint8_t wan_pd_byte_th_index, uint16_t *pdlimit0, uint16_t *pdlimit1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_pd_byte_th_index, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH, reg_wan_configurations_pd_byte_th);

    *pdlimit0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT0, reg_wan_configurations_pd_byte_th);
    *pdlimit1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT1, reg_wan_configurations_pd_byte_th);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pd_byte_th_en_set(uint8_t bbh_id_tx, bdmf_boolean pdlimiten)
{
    ...
    reg_wan_configurations_pd_byte_th_en = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH_EN, PDLIMITEN, reg_wan_configurations_pd_byte_th_en, pdlimiten);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH_EN, reg_wan_configurations_pd_byte_th_en);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pd_byte_th_en_get(uint8_t bbh_id_tx, bdmf_boolean *pdlimiten)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH_EN, reg_wan_configurations_pd_byte_th_en);

    *pdlimiten = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PD_BYTE_TH_EN, PDLIMITEN, reg_wan_configurations_pd_byte_th_en);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdempty_set(uint8_t bbh_id_tx, uint8_t empty)
{
    ...
    reg_wan_configurations_pdempty = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDEMPTY, EMPTY, reg_wan_configurations_pdempty, empty);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDEMPTY, reg_wan_configurations_pdempty);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_pdempty_get(uint8_t bbh_id_tx, uint8_t *empty)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDEMPTY, reg_wan_configurations_pdempty);

    *empty = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_PDEMPTY, EMPTY, reg_wan_configurations_pdempty);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_stsrnrcfg_1_set(uint8_t bbh_id_tx, uint8_t wan_sts_rnr_cfg_1_index, uint16_t tcontaddr)
{
    ...
    reg_wan_configurations_stsrnrcfg_1 = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_STSRNRCFG_1, TCONTADDR, reg_wan_configurations_stsrnrcfg_1, tcontaddr);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_sts_rnr_cfg_1_index, BBH_TX, WAN_CONFIGURATIONS_STSRNRCFG_1, reg_wan_configurations_stsrnrcfg_1);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_stsrnrcfg_1_get(uint8_t bbh_id_tx, uint8_t wan_sts_rnr_cfg_1_index, uint16_t *tcontaddr)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_sts_rnr_cfg_1_index, BBH_TX, WAN_CONFIGURATIONS_STSRNRCFG_1, reg_wan_configurations_stsrnrcfg_1);

    *tcontaddr = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_STSRNRCFG_1, TCONTADDR, reg_wan_configurations_stsrnrcfg_1);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_stsrnrcfg_2_set(uint8_t bbh_id_tx, uint8_t wan_sts_rnr_cfg_2_index, uint16_t ptraddr, uint8_t task)
{
    ...
    reg_wan_configurations_stsrnrcfg_2 = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_STSRNRCFG_2, PTRADDR, reg_wan_configurations_stsrnrcfg_2, ptraddr);
    reg_wan_configurations_stsrnrcfg_2 = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_STSRNRCFG_2, TASK, reg_wan_configurations_stsrnrcfg_2, task);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_sts_rnr_cfg_2_index, BBH_TX, WAN_CONFIGURATIONS_STSRNRCFG_2, reg_wan_configurations_stsrnrcfg_2);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_stsrnrcfg_2_get(uint8_t bbh_id_tx, uint8_t wan_sts_rnr_cfg_2_index, uint16_t *ptraddr, uint8_t *task)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_sts_rnr_cfg_2_index, BBH_TX, WAN_CONFIGURATIONS_STSRNRCFG_2, reg_wan_configurations_stsrnrcfg_2);

    *ptraddr = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_STSRNRCFG_2, PTRADDR, reg_wan_configurations_stsrnrcfg_2);
    *task = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_STSRNRCFG_2, TASK, reg_wan_configurations_stsrnrcfg_2);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_msgrnrcfg_1_set(uint8_t bbh_id_tx, uint8_t wan_msg_rnr_cfg_1_index, uint16_t tcontaddr)
{
    ...
    reg_wan_configurations_msgrnrcfg_1 = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_MSGRNRCFG_1, TCONTADDR, reg_wan_configurations_msgrnrcfg_1, tcontaddr);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_msg_rnr_cfg_1_index, BBH_TX, WAN_CONFIGURATIONS_MSGRNRCFG_1, reg_wan_configurations_msgrnrcfg_1);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_msgrnrcfg_1_get(uint8_t bbh_id_tx, uint8_t wan_msg_rnr_cfg_1_index, uint16_t *tcontaddr)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_msg_rnr_cfg_1_index, BBH_TX, WAN_CONFIGURATIONS_MSGRNRCFG_1, reg_wan_configurations_msgrnrcfg_1);

    *tcontaddr = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_MSGRNRCFG_1, TCONTADDR, reg_wan_configurations_msgrnrcfg_1);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_msgrnrcfg_2_set(uint8_t bbh_id_tx, uint8_t wan_msg_rnr_cfg_2_index, uint16_t ptraddr, uint8_t task)
{
    ...
    reg_wan_configurations_msgrnrcfg_2 = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_MSGRNRCFG_2, PTRADDR, reg_wan_configurations_msgrnrcfg_2, ptraddr);
    reg_wan_configurations_msgrnrcfg_2 = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_MSGRNRCFG_2, TASK, reg_wan_configurations_msgrnrcfg_2, task);

    RU_REG_RAM_WRITE(bbh_id_tx, wan_msg_rnr_cfg_2_index, BBH_TX, WAN_CONFIGURATIONS_MSGRNRCFG_2, reg_wan_configurations_msgrnrcfg_2);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_msgrnrcfg_2_get(uint8_t bbh_id_tx, uint8_t wan_msg_rnr_cfg_2_index, uint16_t *ptraddr, uint8_t *task)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, wan_msg_rnr_cfg_2_index, BBH_TX, WAN_CONFIGURATIONS_MSGRNRCFG_2, reg_wan_configurations_msgrnrcfg_2);

    *ptraddr = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_MSGRNRCFG_2, PTRADDR, reg_wan_configurations_msgrnrcfg_2);
    *task = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_MSGRNRCFG_2, TASK, reg_wan_configurations_msgrnrcfg_2);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_epncfg_set(uint8_t bbh_id_tx, bdmf_boolean stplenerr, bdmf_boolean cmp_width, bdmf_boolean considerfull, bdmf_boolean addcrc)
{
    ...
    reg_wan_configurations_epncfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, STPLENERR, reg_wan_configurations_epncfg, stplenerr);
    reg_wan_configurations_epncfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, CMP_WIDTH, reg_wan_configurations_epncfg, cmp_width);
    reg_wan_configurations_epncfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, CONSIDERFULL, reg_wan_configurations_epncfg, considerfull);
    reg_wan_configurations_epncfg = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, ADDCRC, reg_wan_configurations_epncfg, addcrc);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, reg_wan_configurations_epncfg);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_epncfg_get(uint8_t bbh_id_tx, bdmf_boolean *stplenerr, bdmf_boolean *cmp_width, bdmf_boolean *considerfull, bdmf_boolean *addcrc)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, reg_wan_configurations_epncfg);

    *stplenerr = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, STPLENERR, reg_wan_configurations_epncfg);
    *cmp_width = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, CMP_WIDTH, reg_wan_configurations_epncfg);
    *considerfull = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, CONSIDERFULL, reg_wan_configurations_epncfg);
    *addcrc = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_EPNCFG, ADDCRC, reg_wan_configurations_epncfg);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_flow2port_set(uint8_t bbh_id_tx, uint32_t wdata, uint8_t a, bdmf_boolean cmd)
{
    ...
    reg_wan_configurations_flow2port = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLOW2PORT, WDATA, reg_wan_configurations_flow2port, wdata);
    reg_wan_configurations_flow2port = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLOW2PORT, A, reg_wan_configurations_flow2port, a);
    reg_wan_configurations_flow2port = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLOW2PORT, CMD, reg_wan_configurations_flow2port, cmd);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLOW2PORT, reg_wan_configurations_flow2port);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_flow2port_get(uint8_t bbh_id_tx, uint32_t *wdata, uint8_t *a, bdmf_boolean *cmd)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLOW2PORT, reg_wan_configurations_flow2port);

    *wdata = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLOW2PORT, WDATA, reg_wan_configurations_flow2port);
    *a = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLOW2PORT, A, reg_wan_configurations_flow2port);
    *cmd = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLOW2PORT, CMD, reg_wan_configurations_flow2port);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_ts_set(uint8_t bbh_id_tx, bdmf_boolean en)
{
    ...
    reg_wan_configurations_ts = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_TS, EN, reg_wan_configurations_ts, en);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_TS, reg_wan_configurations_ts);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_ts_get(uint8_t bbh_id_tx, bdmf_boolean *en)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_TS, reg_wan_configurations_ts);

    *en = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_TS, EN, reg_wan_configurations_ts);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_maxwlen_set(uint8_t bbh_id_tx, uint16_t maxwlen)
{
    ...
    reg_wan_configurations_maxwlen = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_MAXWLEN, MAXWLEN, reg_wan_configurations_maxwlen, maxwlen);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_MAXWLEN, reg_wan_configurations_maxwlen);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_maxwlen_get(uint8_t bbh_id_tx, uint16_t *maxwlen)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_MAXWLEN, reg_wan_configurations_maxwlen);

    *maxwlen = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_MAXWLEN, MAXWLEN, reg_wan_configurations_maxwlen);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_flush_set(uint8_t bbh_id_tx, uint16_t flush, bdmf_boolean srst_n)
{
    ...
    reg_wan_configurations_flush = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLUSH, FLUSH, reg_wan_configurations_flush, flush);
    reg_wan_configurations_flush = RU_FIELD_SET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLUSH, SRST_N, reg_wan_configurations_flush, srst_n);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLUSH, reg_wan_configurations_flush);
...
bdmf_error_t ag_drv_bbh_tx_wan_configurations_flush_get(uint8_t bbh_id_tx, uint16_t *flush, bdmf_boolean *srst_n)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLUSH, reg_wan_configurations_flush);

    *flush = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLUSH, FLUSH, reg_wan_configurations_flush);
    *srst_n = RU_FIELD_GET(bbh_id_tx, BBH_TX, WAN_CONFIGURATIONS_FLUSH, SRST_N, reg_wan_configurations_flush);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pdbase_set(uint8_t bbh_id_tx, uint16_t fifobase0, uint16_t fifobase1)
{
    ...
    reg_lan_configurations_pdbase = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDBASE, FIFOBASE0, reg_lan_configurations_pdbase, fifobase0);
    reg_lan_configurations_pdbase = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDBASE, FIFOBASE1, reg_lan_configurations_pdbase, fifobase1);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDBASE, reg_lan_configurations_pdbase);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pdbase_get(uint8_t bbh_id_tx, uint16_t *fifobase0, uint16_t *fifobase1)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDBASE, reg_lan_configurations_pdbase);

    *fifobase0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDBASE, FIFOBASE0, reg_lan_configurations_pdbase);
    *fifobase1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDBASE, FIFOBASE1, reg_lan_configurations_pdbase);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pdsize_set(uint8_t bbh_id_tx, uint16_t fifosize0, uint16_t fifosize1)
{
    ...
    reg_lan_configurations_pdsize = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDSIZE, FIFOSIZE0, reg_lan_configurations_pdsize, fifosize0);
    reg_lan_configurations_pdsize = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDSIZE, FIFOSIZE1, reg_lan_configurations_pdsize, fifosize1);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDSIZE, reg_lan_configurations_pdsize);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pdsize_get(uint8_t bbh_id_tx, uint16_t *fifosize0, uint16_t *fifosize1)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDSIZE, reg_lan_configurations_pdsize);

    *fifosize0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDSIZE, FIFOSIZE0, reg_lan_configurations_pdsize);
    *fifosize1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDSIZE, FIFOSIZE1, reg_lan_configurations_pdsize);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pdwkuph_set(uint8_t bbh_id_tx, uint8_t wkupthresh0, uint8_t wkupthresh1)
{
    ...
    reg_lan_configurations_pdwkuph = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDWKUPH, WKUPTHRESH0, reg_lan_configurations_pdwkuph, wkupthresh0);
    reg_lan_configurations_pdwkuph = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDWKUPH, WKUPTHRESH1, reg_lan_configurations_pdwkuph, wkupthresh1);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDWKUPH, reg_lan_configurations_pdwkuph);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pdwkuph_get(uint8_t bbh_id_tx, uint8_t *wkupthresh0, uint8_t *wkupthresh1)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDWKUPH, reg_lan_configurations_pdwkuph);

    *wkupthresh0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDWKUPH, WKUPTHRESH0, reg_lan_configurations_pdwkuph);
    *wkupthresh1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDWKUPH, WKUPTHRESH1, reg_lan_configurations_pdwkuph);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pd_byte_th_set(uint8_t bbh_id_tx, uint16_t pdlimit0, uint16_t pdlimit1)
{
    ...
    reg_lan_configurations_pd_byte_th = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT0, reg_lan_configurations_pd_byte_th, pdlimit0);
    reg_lan_configurations_pd_byte_th = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT1, reg_lan_configurations_pd_byte_th, pdlimit1);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PD_BYTE_TH, reg_lan_configurations_pd_byte_th);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pd_byte_th_get(uint8_t bbh_id_tx, uint16_t *pdlimit0, uint16_t *pdlimit1)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PD_BYTE_TH, reg_lan_configurations_pd_byte_th);

    *pdlimit0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT0, reg_lan_configurations_pd_byte_th);
    *pdlimit1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT1, reg_lan_configurations_pd_byte_th);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pd_byte_th_en_set(uint8_t bbh_id_tx, bdmf_boolean pdlimiten)
{
    ...
    reg_lan_configurations_pd_byte_th_en = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PD_BYTE_TH_EN, PDLIMITEN, reg_lan_configurations_pd_byte_th_en, pdlimiten);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PD_BYTE_TH_EN, reg_lan_configurations_pd_byte_th_en);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pd_byte_th_en_get(uint8_t bbh_id_tx, bdmf_boolean *pdlimiten)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PD_BYTE_TH_EN, reg_lan_configurations_pd_byte_th_en);

    *pdlimiten = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PD_BYTE_TH_EN, PDLIMITEN, reg_lan_configurations_pd_byte_th_en);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pdempty_set(uint8_t bbh_id_tx, uint8_t empty)
{
    ...
    reg_lan_configurations_pdempty = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDEMPTY, EMPTY, reg_lan_configurations_pdempty, empty);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDEMPTY, reg_lan_configurations_pdempty);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_pdempty_get(uint8_t bbh_id_tx, uint8_t *empty)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDEMPTY, reg_lan_configurations_pdempty);

    *empty = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_PDEMPTY, EMPTY, reg_lan_configurations_pdempty);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_txthresh_set(uint8_t bbh_id_tx, uint16_t ddrthresh, uint16_t sramthresh)
{
    ...
    reg_lan_configurations_txthresh = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_TXTHRESH, DDRTHRESH, reg_lan_configurations_txthresh, ddrthresh);
    reg_lan_configurations_txthresh = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_TXTHRESH, SRAMTHRESH, reg_lan_configurations_txthresh, sramthresh);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_TXTHRESH, reg_lan_configurations_txthresh);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_txthresh_get(uint8_t bbh_id_tx, uint16_t *ddrthresh, uint16_t *sramthresh)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_TXTHRESH, reg_lan_configurations_txthresh);

    *ddrthresh = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_TXTHRESH, DDRTHRESH, reg_lan_configurations_txthresh);
    *sramthresh = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_TXTHRESH, SRAMTHRESH, reg_lan_configurations_txthresh);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_eee_set(uint8_t bbh_id_tx, bdmf_boolean en)
{
    ...
    reg_lan_configurations_eee = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_EEE, EN, reg_lan_configurations_eee, en);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_EEE, reg_lan_configurations_eee);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_eee_get(uint8_t bbh_id_tx, bdmf_boolean *en)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_EEE, reg_lan_configurations_eee);

    *en = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_EEE, EN, reg_lan_configurations_eee);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_ts_set(uint8_t bbh_id_tx, bdmf_boolean en)
{
    ...
    reg_lan_configurations_ts = RU_FIELD_SET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_TS, EN, reg_lan_configurations_ts, en);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_TS, reg_lan_configurations_ts);
...
bdmf_error_t ag_drv_bbh_tx_lan_configurations_ts_get(uint8_t bbh_id_tx, bdmf_boolean *en)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_TS, reg_lan_configurations_ts);

    *en = RU_FIELD_GET(bbh_id_tx, BBH_TX, LAN_CONFIGURATIONS_TS, EN, reg_lan_configurations_ts);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdbase_set(uint8_t bbh_id_tx, uint8_t unified_pd_base_index, uint16_t fifobase0, uint16_t fifobase1)
{
    ...
    reg_unified_configurations_pdbase = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDBASE, FIFOBASE0, reg_unified_configurations_pdbase, fifobase0);
    reg_unified_configurations_pdbase = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDBASE, FIFOBASE1, reg_unified_configurations_pdbase, fifobase1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_pd_base_index, BBH_TX, UNIFIED_CONFIGURATIONS_PDBASE, reg_unified_configurations_pdbase);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdbase_get(uint8_t bbh_id_tx, uint8_t unified_pd_base_index, uint16_t *fifobase0, uint16_t *fifobase1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_pd_base_index, BBH_TX, UNIFIED_CONFIGURATIONS_PDBASE, reg_unified_configurations_pdbase);

    *fifobase0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDBASE, FIFOBASE0, reg_unified_configurations_pdbase);
    *fifobase1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDBASE, FIFOBASE1, reg_unified_configurations_pdbase);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdsize_set(uint8_t bbh_id_tx, uint8_t unified_pd_size_index, uint16_t fifosize0, uint16_t fifosize1)
{
    ...
    reg_unified_configurations_pdsize = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDSIZE, FIFOSIZE0, reg_unified_configurations_pdsize, fifosize0);
    reg_unified_configurations_pdsize = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDSIZE, FIFOSIZE1, reg_unified_configurations_pdsize, fifosize1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_pd_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_PDSIZE, reg_unified_configurations_pdsize);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdsize_get(uint8_t bbh_id_tx, uint8_t unified_pd_size_index, uint16_t *fifosize0, uint16_t *fifosize1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_pd_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_PDSIZE, reg_unified_configurations_pdsize);

    *fifosize0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDSIZE, FIFOSIZE0, reg_unified_configurations_pdsize);
    *fifosize1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDSIZE, FIFOSIZE1, reg_unified_configurations_pdsize);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdwkuph_set(uint8_t bbh_id_tx, uint8_t unified_pd_wkup_index, uint8_t wkupthresh0, uint8_t wkupthresh1)
{
    ...
    reg_unified_configurations_pdwkuph = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDWKUPH, WKUPTHRESH0, reg_unified_configurations_pdwkuph, wkupthresh0);
    reg_unified_configurations_pdwkuph = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDWKUPH, WKUPTHRESH1, reg_unified_configurations_pdwkuph, wkupthresh1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_pd_wkup_index, BBH_TX, UNIFIED_CONFIGURATIONS_PDWKUPH, reg_unified_configurations_pdwkuph);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdwkuph_get(uint8_t bbh_id_tx, uint8_t unified_pd_wkup_index, uint8_t *wkupthresh0, uint8_t *wkupthresh1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_pd_wkup_index, BBH_TX, UNIFIED_CONFIGURATIONS_PDWKUPH, reg_unified_configurations_pdwkuph);

    *wkupthresh0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDWKUPH, WKUPTHRESH0, reg_unified_configurations_pdwkuph);
    *wkupthresh1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDWKUPH, WKUPTHRESH1, reg_unified_configurations_pdwkuph);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pd_byte_th_set(uint8_t bbh_id_tx, uint8_t unified_pd_byte_th_index, uint16_t pdlimit0, uint16_t pdlimit1)
{
    ...
    reg_unified_configurations_pd_byte_th = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT0, reg_unified_configurations_pd_byte_th, pdlimit0);
    reg_unified_configurations_pd_byte_th = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT1, reg_unified_configurations_pd_byte_th, pdlimit1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_pd_byte_th_index, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH, reg_unified_configurations_pd_byte_th);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pd_byte_th_get(uint8_t bbh_id_tx, uint8_t unified_pd_byte_th_index, uint16_t *pdlimit0, uint16_t *pdlimit1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_pd_byte_th_index, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH, reg_unified_configurations_pd_byte_th);

    *pdlimit0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT0, reg_unified_configurations_pd_byte_th);
    *pdlimit1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH, PDLIMIT1, reg_unified_configurations_pd_byte_th);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pd_byte_th_en_set(uint8_t bbh_id_tx, bdmf_boolean pdlimiten)
{
    ...
    reg_unified_configurations_pd_byte_th_en = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH_EN, PDLIMITEN, reg_unified_configurations_pd_byte_th_en, pdlimiten);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH_EN, reg_unified_configurations_pd_byte_th_en);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pd_byte_th_en_get(uint8_t bbh_id_tx, bdmf_boolean *pdlimiten)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH_EN, reg_unified_configurations_pd_byte_th_en);

    *pdlimiten = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PD_BYTE_TH_EN, PDLIMITEN, reg_unified_configurations_pd_byte_th_en);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdempty_set(uint8_t bbh_id_tx, uint8_t empty)
{
    ...
    reg_unified_configurations_pdempty = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDEMPTY, EMPTY, reg_unified_configurations_pdempty, empty);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDEMPTY, reg_unified_configurations_pdempty);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_pdempty_get(uint8_t bbh_id_tx, uint8_t *empty)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDEMPTY, reg_unified_configurations_pdempty);

    *empty = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_PDEMPTY, EMPTY, reg_unified_configurations_pdempty);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_gtxthresh_set(uint8_t bbh_id_tx, uint16_t ddrthresh, uint16_t sramthresh)
{
    ...
    reg_unified_configurations_gtxthresh = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_GTXTHRESH, DDRTHRESH, reg_unified_configurations_gtxthresh, ddrthresh);
    reg_unified_configurations_gtxthresh = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_GTXTHRESH, SRAMTHRESH, reg_unified_configurations_gtxthresh, sramthresh);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_GTXTHRESH, reg_unified_configurations_gtxthresh);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_gtxthresh_get(uint8_t bbh_id_tx, uint16_t *ddrthresh, uint16_t *sramthresh)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_GTXTHRESH, reg_unified_configurations_gtxthresh);

    *ddrthresh = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_GTXTHRESH, DDRTHRESH, reg_unified_configurations_gtxthresh);
    *sramthresh = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_GTXTHRESH, SRAMTHRESH, reg_unified_configurations_gtxthresh);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_eee_set(uint8_t bbh_id_tx, uint8_t en)
{
    ...
    reg_unified_configurations_eee = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_EEE, EN, reg_unified_configurations_eee, en);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_EEE, reg_unified_configurations_eee);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_eee_get(uint8_t bbh_id_tx, uint8_t *en)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_EEE, reg_unified_configurations_eee);

    *en = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_EEE, EN, reg_unified_configurations_eee);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_ts_set(uint8_t bbh_id_tx, uint8_t en)
{
    ...
    reg_unified_configurations_ts = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TS, EN, reg_unified_configurations_ts, en);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TS, reg_unified_configurations_ts);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_ts_get(uint8_t bbh_id_tx, uint8_t *en)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TS, reg_unified_configurations_ts);

    *en = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TS, EN, reg_unified_configurations_ts);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_febase_set(uint8_t bbh_id_tx, uint8_t unified_fe_base_index, uint16_t fifobase0, uint16_t fifobase1)
{
    ...
    reg_unified_configurations_febase = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEBASE, FIFOBASE0, reg_unified_configurations_febase, fifobase0);
    reg_unified_configurations_febase = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEBASE, FIFOBASE1, reg_unified_configurations_febase, fifobase1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_fe_base_index, BBH_TX, UNIFIED_CONFIGURATIONS_FEBASE, reg_unified_configurations_febase);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_febase_get(uint8_t bbh_id_tx, uint8_t unified_fe_base_index, uint16_t *fifobase0, uint16_t *fifobase1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_fe_base_index, BBH_TX, UNIFIED_CONFIGURATIONS_FEBASE, reg_unified_configurations_febase);

    *fifobase0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEBASE, FIFOBASE0, reg_unified_configurations_febase);
    *fifobase1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEBASE, FIFOBASE1, reg_unified_configurations_febase);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_fesize_set(uint8_t bbh_id_tx, uint8_t unified_fe_size_index, uint16_t fifosize0, uint16_t fifosize1)
{
    ...
    reg_unified_configurations_fesize = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FESIZE, FIFOSIZE0, reg_unified_configurations_fesize, fifosize0);
    reg_unified_configurations_fesize = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FESIZE, FIFOSIZE1, reg_unified_configurations_fesize, fifosize1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_fe_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_FESIZE, reg_unified_configurations_fesize);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_fesize_get(uint8_t bbh_id_tx, uint8_t unified_fe_size_index, uint16_t *fifosize0, uint16_t *fifosize1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_fe_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_FESIZE, reg_unified_configurations_fesize);

    *fifosize0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FESIZE, FIFOSIZE0, reg_unified_configurations_fesize);
    *fifosize1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FESIZE, FIFOSIZE1, reg_unified_configurations_fesize);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_fepdbase_set(uint8_t bbh_id_tx, uint8_t unified_fe_pd_base_index, uint8_t fifobase0, uint8_t fifobase1)
{
    ...
    reg_unified_configurations_fepdbase = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDBASE, FIFOBASE0, reg_unified_configurations_fepdbase, fifobase0);
    reg_unified_configurations_fepdbase = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDBASE, FIFOBASE1, reg_unified_configurations_fepdbase, fifobase1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_fe_pd_base_index, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDBASE, reg_unified_configurations_fepdbase);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_fepdbase_get(uint8_t bbh_id_tx, uint8_t unified_fe_pd_base_index, uint8_t *fifobase0, uint8_t *fifobase1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_fe_pd_base_index, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDBASE, reg_unified_configurations_fepdbase);

    *fifobase0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDBASE, FIFOBASE0, reg_unified_configurations_fepdbase);
    *fifobase1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDBASE, FIFOBASE1, reg_unified_configurations_fepdbase);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_fepdsize_set(uint8_t bbh_id_tx, uint8_t unified_fe_pd_size_index, uint8_t fifosize0, uint8_t fifosize1)
{
    ...
    reg_unified_configurations_fepdsize = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDSIZE, FIFOSIZE0, reg_unified_configurations_fepdsize, fifosize0);
    reg_unified_configurations_fepdsize = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDSIZE, FIFOSIZE1, reg_unified_configurations_fepdsize, fifosize1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_fe_pd_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDSIZE, reg_unified_configurations_fepdsize);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_fepdsize_get(uint8_t bbh_id_tx, uint8_t unified_fe_pd_size_index, uint8_t *fifosize0, uint8_t *fifosize1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_fe_pd_size_index, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDSIZE, reg_unified_configurations_fepdsize);

    *fifosize0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDSIZE, FIFOSIZE0, reg_unified_configurations_fepdsize);
    *fifosize1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_FEPDSIZE, FIFOSIZE1, reg_unified_configurations_fepdsize);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_txwrr_set(uint8_t bbh_id_tx, uint8_t unified_tx_wrr_index, uint8_t w0, uint8_t w1)
{
    ...
    reg_unified_configurations_txwrr = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TXWRR, W0, reg_unified_configurations_txwrr, w0);
    reg_unified_configurations_txwrr = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TXWRR, W1, reg_unified_configurations_txwrr, w1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_tx_wrr_index, BBH_TX, UNIFIED_CONFIGURATIONS_TXWRR, reg_unified_configurations_txwrr);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_txwrr_get(uint8_t bbh_id_tx, uint8_t unified_tx_wrr_index, uint8_t *w0, uint8_t *w1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_tx_wrr_index, BBH_TX, UNIFIED_CONFIGURATIONS_TXWRR, reg_unified_configurations_txwrr);

    *w0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TXWRR, W0, reg_unified_configurations_txwrr);
    *w1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TXWRR, W1, reg_unified_configurations_txwrr);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_txthresh_set(uint8_t bbh_id_tx, uint8_t unified_tx_thr_index, uint16_t thresh0, uint16_t thresh1)
{
    ...
    reg_unified_configurations_txthresh = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TXTHRESH, THRESH0, reg_unified_configurations_txthresh, thresh0);
    reg_unified_configurations_txthresh = RU_FIELD_SET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TXTHRESH, THRESH1, reg_unified_configurations_txthresh, thresh1);

    RU_REG_RAM_WRITE(bbh_id_tx, unified_tx_thr_index, BBH_TX, UNIFIED_CONFIGURATIONS_TXTHRESH, reg_unified_configurations_txthresh);
...
bdmf_error_t ag_drv_bbh_tx_unified_configurations_txthresh_get(uint8_t bbh_id_tx, uint8_t unified_tx_thr_index, uint16_t *thresh0, uint16_t *thresh1)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, unified_tx_thr_index, BBH_TX, UNIFIED_CONFIGURATIONS_TXTHRESH, reg_unified_configurations_txthresh);

    *thresh0 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TXTHRESH, THRESH0, reg_unified_configurations_txthresh);
    *thresh1 = RU_FIELD_GET(bbh_id_tx, BBH_TX, UNIFIED_CONFIGURATIONS_TXTHRESH, THRESH1, reg_unified_configurations_txthresh);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_srambyte_get(uint8_t bbh_id_tx, uint32_t *srambyte)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SRAMBYTE, reg_debug_counters_srambyte);

    *srambyte = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SRAMBYTE, SRAMBYTE, reg_debug_counters_srambyte);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_ddrbyte_get(uint8_t bbh_id_tx, uint32_t *ddrbyte)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_DDRBYTE, reg_debug_counters_ddrbyte);

    *ddrbyte = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_DDRBYTE, DDRBYTE, reg_debug_counters_ddrbyte);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_swrden_set(uint8_t bbh_id_tx, const bbh_tx_debug_counters_swrden *debug_counters_swrden)
{
    ...
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDSEL, reg_debug_counters_swrden, debug_counters_swrden->pdsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDVSEL, reg_debug_counters_swrden, debug_counters_swrden->pdvsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDEMPTYSEL, reg_debug_counters_swrden, debug_counters_swrden->pdemptysel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDFULLSEL, reg_debug_counters_swrden, debug_counters_swrden->pdfullsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDBEMPTYSEL, reg_debug_counters_swrden, debug_counters_swrden->pdbemptysel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDFFWKPSEL, reg_debug_counters_swrden, debug_counters_swrden->pdffwkpsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, FBNSEL, reg_debug_counters_swrden, debug_counters_swrden->fbnsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, FBNVSEL, reg_debug_counters_swrden, debug_counters_swrden->fbnvsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, FBNEMPTYSEL, reg_debug_counters_swrden, debug_counters_swrden->fbnemptysel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, FBNFULLSEL, reg_debug_counters_swrden, debug_counters_swrden->fbnfullsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, GETNEXTSEL, reg_debug_counters_swrden, debug_counters_swrden->getnextsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, GETNEXTVSEL, reg_debug_counters_swrden, debug_counters_swrden->getnextvsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, GETNEXTEMPTYSEL, reg_debug_counters_swrden, debug_counters_swrden->getnextemptysel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, GETNEXTFULLSEL, reg_debug_counters_swrden, debug_counters_swrden->getnextfullsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, GPNCNTXTSEL, reg_debug_counters_swrden, debug_counters_swrden->gpncntxtsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, BPMSEL, reg_debug_counters_swrden, debug_counters_swrden->bpmsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, BPMFSEL, reg_debug_counters_swrden, debug_counters_swrden->bpmfsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, SBPMSEL, reg_debug_counters_swrden, debug_counters_swrden->sbpmsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, SBPMFSEL, reg_debug_counters_swrden, debug_counters_swrden->sbpmfsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSSEL, reg_debug_counters_swrden, debug_counters_swrden->stssel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSVSEL, reg_debug_counters_swrden, debug_counters_swrden->stsvsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSEMPTYSEL, reg_debug_counters_swrden, debug_counters_swrden->stsemptysel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSFULLSEL, reg_debug_counters_swrden, debug_counters_swrden->stsfullsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSBEMPTYSEL, reg_debug_counters_swrden, debug_counters_swrden->stsbemptysel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSFFWKPSEL, reg_debug_counters_swrden, debug_counters_swrden->stsffwkpsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, MSGSEL, reg_debug_counters_swrden, debug_counters_swrden->msgsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, MSGVSEL, reg_debug_counters_swrden, debug_counters_swrden->msgvsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, EPNREQSEL, reg_debug_counters_swrden, debug_counters_swrden->epnreqsel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, DATASEL, reg_debug_counters_swrden, debug_counters_swrden->datasel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, REORDERSEL, reg_debug_counters_swrden, debug_counters_swrden->reordersel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, TSINFOSEL, reg_debug_counters_swrden, debug_counters_swrden->tsinfosel);
    reg_debug_counters_swrden = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, MACTXSEL, reg_debug_counters_swrden, debug_counters_swrden->mactxsel);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, reg_debug_counters_swrden);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_swrden_get(uint8_t bbh_id_tx, bbh_tx_debug_counters_swrden *debug_counters_swrden)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, reg_debug_counters_swrden);

    debug_counters_swrden->pdsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDSEL, reg_debug_counters_swrden);
    debug_counters_swrden->pdvsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDVSEL, reg_debug_counters_swrden);
    debug_counters_swrden->pdemptysel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDEMPTYSEL, reg_debug_counters_swrden);
    debug_counters_swrden->pdfullsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDFULLSEL, reg_debug_counters_swrden);
    debug_counters_swrden->pdbemptysel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDBEMPTYSEL, reg_debug_counters_swrden);
    debug_counters_swrden->pdffwkpsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, PDFFWKPSEL, reg_debug_counters_swrden);
    debug_counters_swrden->fbnsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, FBNSEL, reg_debug_counters_swrden);
    debug_counters_swrden->fbnvsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, FBNVSEL, reg_debug_counters_swrden);
    debug_counters_swrden->fbnemptysel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, FBNEMPTYSEL, reg_debug_counters_swrden);
    debug_counters_swrden->fbnfullsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, FBNFULLSEL, reg_debug_counters_swrden);
    debug_counters_swrden->getnextsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, GETNEXTSEL, reg_debug_counters_swrden);
    debug_counters_swrden->getnextvsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, GETNEXTVSEL, reg_debug_counters_swrden);
    debug_counters_swrden->getnextemptysel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, GETNEXTEMPTYSEL, reg_debug_counters_swrden);
    debug_counters_swrden->getnextfullsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, GETNEXTFULLSEL, reg_debug_counters_swrden);
    debug_counters_swrden->gpncntxtsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, GPNCNTXTSEL, reg_debug_counters_swrden);
    debug_counters_swrden->bpmsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, BPMSEL, reg_debug_counters_swrden);
    debug_counters_swrden->bpmfsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, BPMFSEL, reg_debug_counters_swrden);
    debug_counters_swrden->sbpmsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, SBPMSEL, reg_debug_counters_swrden);
    debug_counters_swrden->sbpmfsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, SBPMFSEL, reg_debug_counters_swrden);
    debug_counters_swrden->stssel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSSEL, reg_debug_counters_swrden);
    debug_counters_swrden->stsvsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSVSEL, reg_debug_counters_swrden);
    debug_counters_swrden->stsemptysel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSEMPTYSEL, reg_debug_counters_swrden);
    debug_counters_swrden->stsfullsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSFULLSEL, reg_debug_counters_swrden);
    debug_counters_swrden->stsbemptysel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSBEMPTYSEL, reg_debug_counters_swrden);
    debug_counters_swrden->stsffwkpsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, STSFFWKPSEL, reg_debug_counters_swrden);
    debug_counters_swrden->msgsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, MSGSEL, reg_debug_counters_swrden);
    debug_counters_swrden->msgvsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, MSGVSEL, reg_debug_counters_swrden);
    debug_counters_swrden->epnreqsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, EPNREQSEL, reg_debug_counters_swrden);
    debug_counters_swrden->datasel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, DATASEL, reg_debug_counters_swrden);
    debug_counters_swrden->reordersel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, REORDERSEL, reg_debug_counters_swrden);
    debug_counters_swrden->tsinfosel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, TSINFOSEL, reg_debug_counters_swrden);
    debug_counters_swrden->mactxsel = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDEN, MACTXSEL, reg_debug_counters_swrden);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_swrdaddr_set(uint8_t bbh_id_tx, uint16_t rdaddr)
{
    ...
    reg_debug_counters_swrdaddr = RU_FIELD_SET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDADDR, RDADDR, reg_debug_counters_swrdaddr, rdaddr);

    RU_REG_WRITE(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDADDR, reg_debug_counters_swrdaddr);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_swrdaddr_get(uint8_t bbh_id_tx, uint16_t *rdaddr)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDADDR, reg_debug_counters_swrdaddr);

    *rdaddr = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDADDR, RDADDR, reg_debug_counters_swrdaddr);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_swrddata_get(uint8_t bbh_id_tx, uint32_t *data)
{
    ...
    RU_REG_READ(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDDATA, reg_debug_counters_swrddata);

    *data = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_SWRDDATA, DATA, reg_debug_counters_swrddata);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_unifiedpkt_get(uint8_t bbh_id_tx, uint8_t debug_unified_pkt_ctr_idx, uint32_t *ddrbyte)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, debug_unified_pkt_ctr_idx, BBH_TX, DEBUG_COUNTERS_UNIFIEDPKT, reg_debug_counters_unifiedpkt);

    *ddrbyte = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_UNIFIEDPKT, DDRBYTE, reg_debug_counters_unifiedpkt);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_unifiedbyte_get(uint8_t bbh_id_tx, uint8_t debug_unified_byte_ctr_idx, uint32_t *ddrbyte)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, debug_unified_byte_ctr_idx, BBH_TX, DEBUG_COUNTERS_UNIFIEDBYTE, reg_debug_counters_unifiedbyte);

    *ddrbyte = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_UNIFIEDBYTE, DDRBYTE, reg_debug_counters_unifiedbyte);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_dbgoutreg_get(uint8_t bbh_id_tx, uint8_t zero, bbh_tx_debug_counters_dbgoutreg *debug_counters_dbgoutreg)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, zero *8 + 0, BBH_TX, DEBUG_COUNTERS_DBGOUTREG, debug_counters_dbgoutreg->debug_out_reg[0]);
    RU_REG_RAM_READ(bbh_id_tx, zero *8 + 1, BBH_TX, DEBUG_COUNTERS_DBGOUTREG, debug_counters_dbgoutreg->debug_out_reg[1]);
    RU_REG_RAM_READ(bbh_id_tx, zero *8 + 2, BBH_TX, DEBUG_COUNTERS_DBGOUTREG, debug_counters_dbgoutreg->debug_out_reg[2]);
    RU_REG_RAM_READ(bbh_id_tx, zero *8 + 3, BBH_TX, DEBUG_COUNTERS_DBGOUTREG, debug_counters_dbgoutreg->debug_out_reg[3]);
    RU_REG_RAM_READ(bbh_id_tx, zero *8 + 4, BBH_TX, DEBUG_COUNTERS_DBGOUTREG, debug_counters_dbgoutreg->debug_out_reg[4]);
    RU_REG_RAM_READ(bbh_id_tx, zero *8 + 5, BBH_TX, DEBUG_COUNTERS_DBGOUTREG, debug_counters_dbgoutreg->debug_out_reg[5]);
    RU_REG_RAM_READ(bbh_id_tx, zero *8 + 6, BBH_TX, DEBUG_COUNTERS_DBGOUTREG, debug_counters_dbgoutreg->debug_out_reg[6]);
    RU_REG_RAM_READ(bbh_id_tx, zero *8 + 7, BBH_TX, DEBUG_COUNTERS_DBGOUTREG, debug_counters_dbgoutreg->debug_out_reg[7]);
...
bdmf_error_t ag_drv_bbh_tx_debug_counters_in_segmentation_get(uint8_t bbh_id_tx, uint8_t bbh_tx_debug_counters_in_segmentation_byte_ctr_idx, uint32_t *in_segmentation)
{
    ...
    RU_REG_RAM_READ(bbh_id_tx, bbh_tx_debug_counters_in_segmentation_byte_ctr_idx, BBH_TX, DEBUG_COUNTERS_IN_SEGMENTATION, reg_debug_counters_in_segmentation);

    *in_segmentation = RU_FIELD_GET(bbh_id_tx, BBH_TX, DEBUG_COUNTERS_IN_SEGMENTATION, IN_SEGMENTATION, reg_debug_counters_in_segmentation);
...
static int bcm_bbh_tx_cli_test(bdmf_session_handle session, const bdmfmon_cmd_parm_t parm[], uint16_t n_parms)
{
    ...
    uint8_t bbh_id_tx = parm[1].value.unumber;
    bdmf_error_t err = BDMF_ERR_OK;

    {
        uint8_t type=gtmv(m, 3);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_mac_type_set(%u %u)\n", bbh_id_tx, type);
        if(!err) ag_drv_bbh_tx_mac_type_set(bbh_id_tx, type);
        if(!err) ag_drv_bbh_tx_mac_type_get( bbh_id_tx, &type);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_cfg_src_id_set(%u %u %u %u %u)\n", bbh_id_tx, cfg_src_id.fpmsrc, cfg_src_id.sbpmsrc, cfg_src_id.stsrnrsrc, cfg_src_id.msgrnrsrc);
        if(!err) ag_drv_bbh_tx_cfg_src_id_set(bbh_id_tx, &cfg_src_id);
        if(!err) ag_drv_bbh_tx_cfg_src_id_get( bbh_id_tx, &cfg_src_id);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_rnr_src_id_set(%u %u %u)\n", bbh_id_tx, pdrnr0src, pdrnr1src);
        if(!err) ag_drv_bbh_tx_rnr_src_id_set(bbh_id_tx, pdrnr0src, pdrnr1src);
        if(!err) ag_drv_bbh_tx_rnr_src_id_get( bbh_id_tx, &pdrnr0src, &pdrnr1src);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_bbh_dma_cfg_set(%u %u %u %u)\n", bbh_id_tx, bbh_dma_cfg.dmasrc, bbh_dma_cfg.descbase, bbh_dma_cfg.descsize);
        if(!err) ag_drv_bbh_tx_bbh_dma_cfg_set(bbh_id_tx, &bbh_dma_cfg);
        if(!err) ag_drv_bbh_tx_bbh_dma_cfg_get( bbh_id_tx, &bbh_dma_cfg);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_dma_max_otf_read_request_set(bbh_id_tx, maxreq);
        if(!err) ag_drv_bbh_tx_dma_max_otf_read_request_get( bbh_id_tx, &maxreq);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_dma_epon_urgent_set(bbh_id_tx, epnurgnt);
        if(!err) ag_drv_bbh_tx_dma_epon_urgent_get( bbh_id_tx, &epnurgnt);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_bbh_sdma_cfg_set(%u %u %u %u)\n", bbh_id_tx, bbh_sdma_cfg.sdmasrc, bbh_sdma_cfg.descbase, bbh_sdma_cfg.descsize);
        if(!err) ag_drv_bbh_tx_bbh_sdma_cfg_set(bbh_id_tx, &bbh_sdma_cfg);
        if(!err) ag_drv_bbh_tx_bbh_sdma_cfg_get( bbh_id_tx, &bbh_sdma_cfg);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_sdma_max_otf_read_request_set(bbh_id_tx, maxreq);
        if(!err) ag_drv_bbh_tx_sdma_max_otf_read_request_get( bbh_id_tx, &maxreq);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_sdma_epon_urgent_set(bbh_id_tx, epnurgnt);
        if(!err) ag_drv_bbh_tx_sdma_epon_urgent_get( bbh_id_tx, &epnurgnt);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_bbh_ddr_cfg_set(%u %u %u %u %u %u)\n", bbh_id_tx, bbh_ddr_cfg.bufsize, bbh_ddr_cfg.byteresul, bbh_ddr_cfg.ddrtxoffset, bbh_ddr_cfg.hnsize0, bbh_ddr_cfg.hnsize1);
        if(!err) ag_drv_bbh_tx_bbh_ddr_cfg_set(bbh_id_tx, &bbh_ddr_cfg);
        if(!err) ag_drv_bbh_tx_bbh_ddr_cfg_get( bbh_id_tx, &bbh_ddr_cfg);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_debug_counters_get( bbh_id_tx, &debug_counters);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_debug_counters_get(%u %u %u %u %u %u %u %u %u %u %u %u %u %u)\n", bbh_id_tx, debug_counters.srampd, debug_counters.ddrpd, debug_counters.pddrop, debug_counters.stscnt, debug_counters.stsdrop, debug_counters.msgcnt, debug_counters.msgdrop, debug_counters.getnextnull, debug_counters.lenerr, debug_counters.aggrlenerr, debug_counters.srampkt, debug_counters.ddrpkt, debug_counters.flshpkts);
    }
    {
        uint8_t rnr_cfg_index_1=gtmv(m, 1);
        uint16_t tcontaddr=gtmv(m, 16);
        uint16_t skbaddr=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_rnrcfg_1_set(%u %u %u %u)\n", bbh_id_tx, rnr_cfg_index_1, tcontaddr, skbaddr);
        if(!err) ag_drv_bbh_tx_common_configurations_rnrcfg_1_set(bbh_id_tx, rnr_cfg_index_1, tcontaddr, skbaddr);
        if(!err) ag_drv_bbh_tx_common_configurations_rnrcfg_1_get( bbh_id_tx, rnr_cfg_index_1, &tcontaddr, &skbaddr);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_rnrcfg_2_set(%u %u %u %u)\n", bbh_id_tx, rnr_cfg_index_2, ptraddr, task);
        if(!err) ag_drv_bbh_tx_common_configurations_rnrcfg_2_set(bbh_id_tx, rnr_cfg_index_2, ptraddr, task);
        if(!err) ag_drv_bbh_tx_common_configurations_rnrcfg_2_get( bbh_id_tx, rnr_cfg_index_2, &ptraddr, &task);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_sbpmcfg_set(%u %u %u %u)\n", bbh_id_tx, freenocntxt, specialfree, maxgn);
        if(!err) ag_drv_bbh_tx_common_configurations_sbpmcfg_set(bbh_id_tx, freenocntxt, specialfree, maxgn);
        if(!err) ag_drv_bbh_tx_common_configurations_sbpmcfg_get( bbh_id_tx, &freenocntxt, &specialfree, &maxgn);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_ddrtmbasel_set(%u %u %u %u)\n", bbh_id_tx, zero, common_configurations_ddrtmbasel.addr[0], common_configurations_ddrtmbasel.addr[1]);
        if(!err) ag_drv_bbh_tx_common_configurations_ddrtmbasel_set(bbh_id_tx, zero, &common_configurations_ddrtmbasel);
        if(!err) ag_drv_bbh_tx_common_configurations_ddrtmbasel_get( bbh_id_tx, zero, &common_configurations_ddrtmbasel);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_ddrtmbaseh_set(%u %u %u %u)\n", bbh_id_tx, zero, common_configurations_ddrtmbaseh.addr[0], common_configurations_ddrtmbaseh.addr[1]);
        if(!err) ag_drv_bbh_tx_common_configurations_ddrtmbaseh_set(bbh_id_tx, zero, &common_configurations_ddrtmbaseh);
        if(!err) ag_drv_bbh_tx_common_configurations_ddrtmbaseh_get( bbh_id_tx, zero, &common_configurations_ddrtmbaseh);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_dfifoctrl_set(%u %u %u %u)\n", bbh_id_tx, psramsize, ddrsize, psrambase);
        if(!err) ag_drv_bbh_tx_common_configurations_dfifoctrl_set(bbh_id_tx, psramsize, ddrsize, psrambase);
        if(!err) ag_drv_bbh_tx_common_configurations_dfifoctrl_get( bbh_id_tx, &psramsize, &ddrsize, &psrambase);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_common_configurations_arb_cfg_set(bbh_id_tx, hightrxq);
        if(!err) ag_drv_bbh_tx_common_configurations_arb_cfg_get( bbh_id_tx, &hightrxq);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_bbroute_set(%u %u %u %u)\n", bbh_id_tx, route, dest, en);
        if(!err) ag_drv_bbh_tx_common_configurations_bbroute_set(bbh_id_tx, route, dest, en);
        if(!err) ag_drv_bbh_tx_common_configurations_bbroute_get( bbh_id_tx, &route, &dest, &en);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_q2rnr_set(%u %u %u %u)\n", bbh_id_tx, q_2_rnr_index, q0, q1);
        if(!err) ag_drv_bbh_tx_common_configurations_q2rnr_set(bbh_id_tx, q_2_rnr_index, q0, q1);
        if(!err) ag_drv_bbh_tx_common_configurations_q2rnr_get( bbh_id_tx, q_2_rnr_index, &q0, &q1);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_common_configurations_dbgsel_set(bbh_id_tx, dbgsel);
        if(!err) ag_drv_bbh_tx_common_configurations_dbgsel_get( bbh_id_tx, &dbgsel);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_common_configurations_clk_gate_cntrl_set(%u %u %u %u %u %u)\n", bbh_id_tx, common_configurations_clk_gate_cntrl.bypass_clk_gate, common_configurations_clk_gate_cntrl.timer_val, common_configurations_clk_gate_cntrl.keep_alive_en, common_configurations_clk_gate_cntrl.keep_alive_intrvl, common_configurations_clk_gate_cntrl.keep_alive_cyc);
        if(!err) ag_drv_bbh_tx_common_configurations_clk_gate_cntrl_set(bbh_id_tx, &common_configurations_clk_gate_cntrl);
        if(!err) ag_drv_bbh_tx_common_configurations_clk_gate_cntrl_get( bbh_id_tx, &common_configurations_clk_gate_cntrl);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_common_configurations_gpr_set(bbh_id_tx, gpr);
        if(!err) ag_drv_bbh_tx_common_configurations_gpr_get( bbh_id_tx, &gpr);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_pdbase_set(%u %u %u %u)\n", bbh_id_tx, wan_pd_base_index, fifobase0, fifobase1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdbase_set(bbh_id_tx, wan_pd_base_index, fifobase0, fifobase1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdbase_get( bbh_id_tx, wan_pd_base_index, &fifobase0, &fifobase1);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_pdsize_set(%u %u %u %u)\n", bbh_id_tx, wan_pd_size_index, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdsize_set(bbh_id_tx, wan_pd_size_index, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdsize_get( bbh_id_tx, wan_pd_size_index, &fifosize0, &fifosize1);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_pdwkuph_set(%u %u %u %u)\n", bbh_id_tx, wan_pd_wkup_index, wkupthresh0, wkupthresh1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdwkuph_set(bbh_id_tx, wan_pd_wkup_index, wkupthresh0, wkupthresh1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdwkuph_get( bbh_id_tx, wan_pd_wkup_index, &wkupthresh0, &wkupthresh1);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_pd_byte_th_set(%u %u %u %u)\n", bbh_id_tx, wan_pd_byte_th_index, pdlimit0, pdlimit1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pd_byte_th_set(bbh_id_tx, wan_pd_byte_th_index, pdlimit0, pdlimit1);
        if(!err) ag_drv_bbh_tx_wan_configurations_pd_byte_th_get( bbh_id_tx, wan_pd_byte_th_index, &pdlimit0, &pdlimit1);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_wan_configurations_pd_byte_th_en_set(bbh_id_tx, pdlimiten);
        if(!err) ag_drv_bbh_tx_wan_configurations_pd_byte_th_en_get( bbh_id_tx, &pdlimiten);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_wan_configurations_pdempty_set(bbh_id_tx, empty);
        if(!err) ag_drv_bbh_tx_wan_configurations_pdempty_get( bbh_id_tx, &empty);
    ...
    }
    {
        ...
        uint16_t tcontaddr=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_stsrnrcfg_1_set(%u %u %u)\n", bbh_id_tx, wan_sts_rnr_cfg_1_index, tcontaddr);
        if(!err) ag_drv_bbh_tx_wan_configurations_stsrnrcfg_1_set(bbh_id_tx, wan_sts_rnr_cfg_1_index, tcontaddr);
        if(!err) ag_drv_bbh_tx_wan_configurations_stsrnrcfg_1_get( bbh_id_tx, wan_sts_rnr_cfg_1_index, &tcontaddr);
    ...
    }
    {
        ...
        uint16_t ptraddr=gtmv(m, 16);
        uint8_t task=gtmv(m, 4);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_stsrnrcfg_2_set(%u %u %u %u)\n", bbh_id_tx, wan_sts_rnr_cfg_2_index, ptraddr, task);
        if(!err) ag_drv_bbh_tx_wan_configurations_stsrnrcfg_2_set(bbh_id_tx, wan_sts_rnr_cfg_2_index, ptraddr, task);
        if(!err) ag_drv_bbh_tx_wan_configurations_stsrnrcfg_2_get( bbh_id_tx, wan_sts_rnr_cfg_2_index, &ptraddr, &task);
    ...
    }
    {
        ...
        uint16_t tcontaddr=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_msgrnrcfg_1_set(%u %u %u)\n", bbh_id_tx, wan_msg_rnr_cfg_1_index, tcontaddr);
        if(!err) ag_drv_bbh_tx_wan_configurations_msgrnrcfg_1_set(bbh_id_tx, wan_msg_rnr_cfg_1_index, tcontaddr);
        if(!err) ag_drv_bbh_tx_wan_configurations_msgrnrcfg_1_get( bbh_id_tx, wan_msg_rnr_cfg_1_index, &tcontaddr);
    ...
    }
    {
        ...
        uint16_t ptraddr=gtmv(m, 16);
        uint8_t task=gtmv(m, 4);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_msgrnrcfg_2_set(%u %u %u %u)\n", bbh_id_tx, wan_msg_rnr_cfg_2_index, ptraddr, task);
        if(!err) ag_drv_bbh_tx_wan_configurations_msgrnrcfg_2_set(bbh_id_tx, wan_msg_rnr_cfg_2_index, ptraddr, task);
        if(!err) ag_drv_bbh_tx_wan_configurations_msgrnrcfg_2_get( bbh_id_tx, wan_msg_rnr_cfg_2_index, &ptraddr, &task);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_epncfg_set(%u %u %u %u %u)\n", bbh_id_tx, stplenerr, cmp_width, considerfull, addcrc);
        if(!err) ag_drv_bbh_tx_wan_configurations_epncfg_set(bbh_id_tx, stplenerr, cmp_width, considerfull, addcrc);
        if(!err) ag_drv_bbh_tx_wan_configurations_epncfg_get( bbh_id_tx, &stplenerr, &cmp_width, &considerfull, &addcrc);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_flow2port_set(%u %u %u %u)\n", bbh_id_tx, wdata, a, cmd);
        if(!err) ag_drv_bbh_tx_wan_configurations_flow2port_set(bbh_id_tx, wdata, a, cmd);
        if(!err) ag_drv_bbh_tx_wan_configurations_flow2port_get( bbh_id_tx, &wdata, &a, &cmd);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_wan_configurations_ts_set(bbh_id_tx, en);
        if(!err) ag_drv_bbh_tx_wan_configurations_ts_get( bbh_id_tx, &en);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_wan_configurations_maxwlen_set(bbh_id_tx, maxwlen);
        if(!err) ag_drv_bbh_tx_wan_configurations_maxwlen_get( bbh_id_tx, &maxwlen);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_wan_configurations_flush_set(%u %u %u)\n", bbh_id_tx, flush, srst_n);
        if(!err) ag_drv_bbh_tx_wan_configurations_flush_set(bbh_id_tx, flush, srst_n);
        if(!err) ag_drv_bbh_tx_wan_configurations_flush_get( bbh_id_tx, &flush, &srst_n);
    ...
    }
    {
        uint16_t fifobase0=gtmv(m, 9);
        uint16_t fifobase1=gtmv(m, 9);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_pdbase_set(%u %u %u)\n", bbh_id_tx, fifobase0, fifobase1);
        if(!err) ag_drv_bbh_tx_lan_configurations_pdbase_set(bbh_id_tx, fifobase0, fifobase1);
        if(!err) ag_drv_bbh_tx_lan_configurations_pdbase_get( bbh_id_tx, &fifobase0, &fifobase1);
    ...
    }
    {
        uint16_t fifosize0=gtmv(m, 9);
        uint16_t fifosize1=gtmv(m, 9);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_pdsize_set(%u %u %u)\n", bbh_id_tx, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_lan_configurations_pdsize_set(bbh_id_tx, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_lan_configurations_pdsize_get( bbh_id_tx, &fifosize0, &fifosize1);
    ...
    }
    {
        uint8_t wkupthresh0=gtmv(m, 8);
        uint8_t wkupthresh1=gtmv(m, 8);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_pdwkuph_set(%u %u %u)\n", bbh_id_tx, wkupthresh0, wkupthresh1);
        if(!err) ag_drv_bbh_tx_lan_configurations_pdwkuph_set(bbh_id_tx, wkupthresh0, wkupthresh1);
        if(!err) ag_drv_bbh_tx_lan_configurations_pdwkuph_get( bbh_id_tx, &wkupthresh0, &wkupthresh1);
    ...
    }
    {
        uint16_t pdlimit0=gtmv(m, 16);
        uint16_t pdlimit1=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_pd_byte_th_set(%u %u %u)\n", bbh_id_tx, pdlimit0, pdlimit1);
        if(!err) ag_drv_bbh_tx_lan_configurations_pd_byte_th_set(bbh_id_tx, pdlimit0, pdlimit1);
        if(!err) ag_drv_bbh_tx_lan_configurations_pd_byte_th_get( bbh_id_tx, &pdlimit0, &pdlimit1);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_lan_configurations_pd_byte_th_en_set(bbh_id_tx, pdlimiten);
        if(!err) ag_drv_bbh_tx_lan_configurations_pd_byte_th_en_get( bbh_id_tx, &pdlimiten);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_lan_configurations_pdempty_set(bbh_id_tx, empty);
        if(!err) ag_drv_bbh_tx_lan_configurations_pdempty_get( bbh_id_tx, &empty);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_lan_configurations_txthresh_set(%u %u %u)\n", bbh_id_tx, ddrthresh, sramthresh);
        if(!err) ag_drv_bbh_tx_lan_configurations_txthresh_set(bbh_id_tx, ddrthresh, sramthresh);
        if(!err) ag_drv_bbh_tx_lan_configurations_txthresh_get( bbh_id_tx, &ddrthresh, &sramthresh);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_lan_configurations_eee_set(bbh_id_tx, en);
        if(!err) ag_drv_bbh_tx_lan_configurations_eee_get( bbh_id_tx, &en);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_lan_configurations_ts_set(bbh_id_tx, en);
        if(!err) ag_drv_bbh_tx_lan_configurations_ts_get( bbh_id_tx, &en);
    ...
    }
    {
        ...
        uint16_t fifobase0=gtmv(m, 9);
        uint16_t fifobase1=gtmv(m, 9);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_pdbase_set(%u %u %u %u)\n", bbh_id_tx, unified_pd_base_index, fifobase0, fifobase1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdbase_set(bbh_id_tx, unified_pd_base_index, fifobase0, fifobase1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdbase_get( bbh_id_tx, unified_pd_base_index, &fifobase0, &fifobase1);
    ...
    }
    {
        ...
        uint16_t fifosize0=gtmv(m, 9);
        uint16_t fifosize1=gtmv(m, 9);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_pdsize_set(%u %u %u %u)\n", bbh_id_tx, unified_pd_size_index, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdsize_set(bbh_id_tx, unified_pd_size_index, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdsize_get( bbh_id_tx, unified_pd_size_index, &fifosize0, &fifosize1);
    ...
    }
    {
        ...
        uint8_t wkupthresh0=gtmv(m, 8);
        uint8_t wkupthresh1=gtmv(m, 8);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_pdwkuph_set(%u %u %u %u)\n", bbh_id_tx, unified_pd_wkup_index, wkupthresh0, wkupthresh1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdwkuph_set(bbh_id_tx, unified_pd_wkup_index, wkupthresh0, wkupthresh1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdwkuph_get( bbh_id_tx, unified_pd_wkup_index, &wkupthresh0, &wkupthresh1);
    ...
    }
    {
        ...
        uint16_t pdlimit0=gtmv(m, 16);
        uint16_t pdlimit1=gtmv(m, 16);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_pd_byte_th_set(%u %u %u %u)\n", bbh_id_tx, unified_pd_byte_th_index, pdlimit0, pdlimit1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pd_byte_th_set(bbh_id_tx, unified_pd_byte_th_index, pdlimit0, pdlimit1);
        if(!err) ag_drv_bbh_tx_unified_configurations_pd_byte_th_get( bbh_id_tx, unified_pd_byte_th_index, &pdlimit0, &pdlimit1);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_unified_configurations_pd_byte_th_en_set(bbh_id_tx, pdlimiten);
        if(!err) ag_drv_bbh_tx_unified_configurations_pd_byte_th_en_get( bbh_id_tx, &pdlimiten);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_unified_configurations_pdempty_set(bbh_id_tx, empty);
        if(!err) ag_drv_bbh_tx_unified_configurations_pdempty_get( bbh_id_tx, &empty);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_unified_configurations_gtxthresh_set(bbh_id_tx, ddrthresh, sramthresh);
        if(!err) ag_drv_bbh_tx_unified_configurations_gtxthresh_get( bbh_id_tx, &ddrthresh, &sramthresh);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_unified_configurations_eee_set(bbh_id_tx, en);
        if(!err) ag_drv_bbh_tx_unified_configurations_eee_get( bbh_id_tx, &en);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_unified_configurations_ts_set(bbh_id_tx, en);
        if(!err) ag_drv_bbh_tx_unified_configurations_ts_get( bbh_id_tx, &en);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_febase_set(%u %u %u %u)\n", bbh_id_tx, unified_fe_base_index, fifobase0, fifobase1);
        if(!err) ag_drv_bbh_tx_unified_configurations_febase_set(bbh_id_tx, unified_fe_base_index, fifobase0, fifobase1);
        if(!err) ag_drv_bbh_tx_unified_configurations_febase_get( bbh_id_tx, unified_fe_base_index, &fifobase0, &fifobase1);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_fesize_set(%u %u %u %u)\n", bbh_id_tx, unified_fe_size_index, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_unified_configurations_fesize_set(bbh_id_tx, unified_fe_size_index, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_unified_configurations_fesize_get( bbh_id_tx, unified_fe_size_index, &fifosize0, &fifosize1);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_fepdbase_set(%u %u %u %u)\n", bbh_id_tx, unified_fe_pd_base_index, fifobase0, fifobase1);
        if(!err) ag_drv_bbh_tx_unified_configurations_fepdbase_set(bbh_id_tx, unified_fe_pd_base_index, fifobase0, fifobase1);
        if(!err) ag_drv_bbh_tx_unified_configurations_fepdbase_get( bbh_id_tx, unified_fe_pd_base_index, &fifobase0, &fifobase1);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_fepdsize_set(%u %u %u %u)\n", bbh_id_tx, unified_fe_pd_size_index, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_unified_configurations_fepdsize_set(bbh_id_tx, unified_fe_pd_size_index, fifosize0, fifosize1);
        if(!err) ag_drv_bbh_tx_unified_configurations_fepdsize_get( bbh_id_tx, unified_fe_pd_size_index, &fifosize0, &fifosize1);
    ...
    }
    {
        ...
        uint8_t w0=gtmv(m, 4);
        uint8_t w1=gtmv(m, 4);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_txwrr_set(%u %u %u %u)\n", bbh_id_tx, unified_tx_wrr_index, w0, w1);
        if(!err) ag_drv_bbh_tx_unified_configurations_txwrr_set(bbh_id_tx, unified_tx_wrr_index, w0, w1);
        if(!err) ag_drv_bbh_tx_unified_configurations_txwrr_get( bbh_id_tx, unified_tx_wrr_index, &w0, &w1);
    ...
    }
    {
        ...
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_unified_configurations_txthresh_set(%u %u %u %u)\n", bbh_id_tx, unified_tx_thr_index, thresh0, thresh1);
        if(!err) ag_drv_bbh_tx_unified_configurations_txthresh_set(bbh_id_tx, unified_tx_thr_index, thresh0, thresh1);
        if(!err) ag_drv_bbh_tx_unified_configurations_txthresh_get( bbh_id_tx, unified_tx_thr_index, &thresh0, &thresh1);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_debug_counters_srambyte_get( bbh_id_tx, &srambyte);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_debug_counters_srambyte_get(%u %u)\n", bbh_id_tx, srambyte);
    }
    {
        uint32_t ddrbyte=gtmv(m, 32);
        if(!err) ag_drv_bbh_tx_debug_counters_ddrbyte_get( bbh_id_tx, &ddrbyte);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_debug_counters_swrdaddr_set(bbh_id_tx, rdaddr);
        if(!err) ag_drv_bbh_tx_debug_counters_swrdaddr_get( bbh_id_tx, &rdaddr);
    ...
    }
    {
        ...
        if(!err) ag_drv_bbh_tx_debug_counters_swrddata_get( bbh_id_tx, &data);
    ...
    }
    {
        ...
        uint32_t ddrbyte=gtmv(m, 32);
        if(!err) ag_drv_bbh_tx_debug_counters_unifiedpkt_get( bbh_id_tx, debug_unified_pkt_ctr_idx, &ddrbyte);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_debug_counters_unifiedpkt_get(%u %u %u)\n", bbh_id_tx, debug_unified_pkt_ctr_idx, ddrbyte);
    }
    {
        uint8_t debug_unified_byte_ctr_idx=gtmv(m, 3);
        uint32_t ddrbyte=gtmv(m, 32);
        if(!err) ag_drv_bbh_tx_debug_counters_unifiedbyte_get( bbh_id_tx, debug_unified_byte_ctr_idx, &ddrbyte);
        if(!err) bdmf_session_print(session, "ag_drv_bbh_tx_debug_counters_unifiedbyte_get(%u %u %u)\n", bbh_id_tx, debug_unified_byte_ctr_idx, ddrbyte);
    }
    {
...
bdmfmon_handle_t ag_drv_bbh_tx_cli_init(bdmfmon_handle_t driver_dir)
{
...

    {
        static bdmfmon_cmd_parm_t set_mac_type[]={
            BDMFMON_MAKE_PARM_ENUM("bbh_id_tx", "bbh_id_tx", bbh_id_tx_enum_table, 0),
    ...
    }
    {
        ...
        static bdmfmon_cmd_parm_t set_common_configurations_rnrcfg_1[]={
            BDMFMON_MAKE_PARM("bbh_id_tx", "bbh_id_tx", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_MAKE_PARM("rnr_cfg_index_1", "rnr_cfg_index_1", BDMFMON_PARM_NUMBER, 0),
            BDMFMON_PARM_LIST_TERMINATOR
        };
        static bdmfmon_cmd_parm_t set_common_configurations_rnrcfg_2[]={
    ...
    }
    {
        ...
        BDMFMON_MAKE_CMD(dir, "address", "address", bcm_bbh_tx_cli_address,
            ...
            BDMFMON_MAKE_PARM_ENUM("index1", "bbh_id_tx", bbh_id_tx_enum_table, 0),
