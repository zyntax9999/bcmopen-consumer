...
bp_pinmux_defs_t g_pinmux_defs_0[] = {
  ...
  { bp_usNetLed0, 0, 18, 18 | BP_PINMUX_VAL_1 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(18)},
  { bp_usNetLed1, 0, 19, 19 | BP_PINMUX_VAL_1 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(19)},
  { bp_usNetLed0, 1, 20, 20 | BP_PINMUX_VAL_1 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(20)},
  { bp_usNetLed1, 1, 21, 21 | BP_PINMUX_VAL_1 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(21)},
  { bp_usNetLed0, 2, 22, 22 | BP_PINMUX_VAL_1 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(22)},
  { bp_usNetLed1, 2, 23, 23 | BP_PINMUX_VAL_1 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(23)},
  { bp_usNetLed0, 3, 24, 24 | BP_PINMUX_VAL_1 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(24)},
  { bp_usNetLed1, 3, 25, 25 | BP_PINMUX_VAL_1 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(25)},
  ...
  { bp_usNetLed0, 0, 45, 45 | BP_PINMUX_VAL_2 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(7)},
  { bp_usNetLed1, 0, 05, 05 | BP_PINMUX_VAL_2 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(8)},
  { bp_usNetLed0, 1, 18, 18 | BP_PINMUX_VAL_2 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(9)},
  { bp_usNetLed1, 1, 50, 50 | BP_PINMUX_VAL_2 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(10)},
  { bp_usNetLed0, 2, 51, 51 | BP_PINMUX_VAL_2 | BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(11)},
  { bp_usNetLed1, 2,  0,                        BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(12)},
  { bp_usNetLed0, 3,  0,                        BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(13)},
  { bp_usNetLed1, 3,  0,                        BP_PINMUX_HWLED | BP_PINMUX_OPTLED_NUM(14)},
