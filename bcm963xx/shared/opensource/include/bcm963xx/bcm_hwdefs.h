...
#define NVRAM_ACS_PASS_LEN 16
#define NVRAM_VARIANT_LEN 6
#define NVRAM_USER_PASS_LEN 8
...
#define NAND_FULL_PARTITION_SEARCH  1
...
# define NVFEAT_RESERVED    (1<<31)     // bit reserved for erasure detection
    ...
    char chUnused[80]; /* Adjust chUnused such that everything above + chUnused[] + ulCheckSum = 1k */
    char acsPassword[NVRAM_ACS_PASS_LEN];
    char variant[NVRAM_VARIANT_LEN];
    char userPass[NVRAM_USER_PASS_LEN];
...
#define NVRAM_WLANFEAT                   "wlanFeature"
#define NVRAM_AUTHKEY                    "szAuthKey"
#define NVRAM_DESKEY                     "szDesKey"
#define NVRAM_WPAKEY                     "szWpaKey"
#define NVRAM_SERIALNO                   "szSerialNumber"
#define NVRAM_RFPI                       "rfpi"
#define NVRAM_MODDEV                     "bcm_mod_dev"
#define NVRAM_DEFFREQ                    "bcm_def_freq"
#define NVRAM_FIXEDEMC                   "fixed_emc"
#define NVRAM_DSLANNEX                   "dslAnnex"
#define NVRAM_IVERSION                   "iVersion"
#define NVRAM_IANTENNA                   "iAntenna"
#define NVRAM_PSN                        "psn"
#define NVRAM_PCBASN                     "pcbasn"
#define NVRAM_HWVER                      "hwVer"
#define NVRAM_PRODUCTION                 "production"
#define NVRAM_ACS_PASS                   "acsPassword"
#define NVRAM_VARIANT                    "variant"
#define NVRAM_USER_PASS                  "userPass"
