...
void bcm_set_watchdog(int enable, int timer, int mode, unsigned int threshold)
{
    ...
    { 
        ...
        if (enable)
        {
            ...
            watchdog_callback_register((void*)&watchdog_isr);
#else
            /* 
...
#elif defined(CONFIG_BCM96858) || defined (CONFIG_BCM963158) || defined(CONFIG_BCM96846) || defined(CONFIG_BCM96878) || defined(CONFIG_BCM963178)
    WDTIMER0->WatchDogCtl = 0xEE00;
    WDTIMER0->WatchDogCtl = 0x00EE;
...
void kerSysRegisterWatchdogCB(char *devname, void *cbfn, void *context)
{
    ...
    {
        printk("Error: kerSysRegisterWatchdogCB: register info not enough (%s,%p,%p)\n", devname, cbfn, context);
        return;
    }
